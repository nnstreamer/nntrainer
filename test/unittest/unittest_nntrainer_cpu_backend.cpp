...
static void run_quant_test(const uint32_t M, const uint32_t K, const uint32_t N,
  ...
  std::vector<float> ref_dst = generate_random_vector<float>(M * N);
...
TEST(nntrainer_cpu_backend_standalone, quant_GEMV_256x256x256) {
  const unsigned int M = 256;
...
TEST(nntrainer_cpu_backend_standalone, quant_GEMV_512x256x512) {
...
TEST(nntrainer_cpu_backend_standalone, quant_GEMV_512x3072x512) {
  const unsigned int M = 512;
  const unsigned int K = 3072;
  const unsigned int N = 512;
  float q4_0_mse, q4_k_mse, q6_k_mse;
...
TEST(nntrainer_cpu_backend_standalone, quant_GEMV_1x3072x512) {
  const unsigned int M = 1;
  const unsigned int K = 3072;
  const unsigned int N = 512;
  float q4_0_mse, q4_k_mse, q6_k_mse;
