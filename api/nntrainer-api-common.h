...
typedef enum {
  ...
  ML_TRAIN_LAYER_TYPE_CAST = 47,     /**< Cast Layer type (Since 9.0)*/
  ML_TRAIN_LAYER_TYPE_GATHER = 48,   /**< Gather Layer type (Since 9.0)*/
  ML_TRAIN_LAYER_TYPE_SLICE = 49,    /**< SQRT Layer type (Since 9.0)*/
  ML_TRAIN_LAYER_TYPE_NEGATIVE = 50, /**< Negative Layer type (Since 9.0)*/
   ML_TRAIN_LAYER_TYPE_REDUCE_SUM = 51, /**< ReduceSum Layer type (Since 9.0) */
