...
extern void __KAI_KMPC_CONVENTION omp_init_lock_with_hint(omp_lock_t *,
                                                          omp_lock_hint_t);
...
extern int __KAI_KMPC_CONVENTION omp_target_memcpy(void *, const void *, size_t,
                                                   size_t, size_t, int, int);
extern int __KAI_KMPC_CONVENTION omp_target_memcpy_rect(
  void *, const void *, size_t, int, const size_t *, const size_t *,
  const size_t *, const size_t *, const size_t *, int, int);
extern int __KAI_KMPC_CONVENTION omp_target_associate_ptr(const void *,
                                                          const void *, size_t,
                                                          size_t, int);
 ...
 */
extern omp_intptr_t __KAI_KMPC_CONVENTION
 ...
 */
extern const char *__KAI_KMPC_CONVENTION
omp_get_interop_name(const omp_interop_t, omp_interop_property_t);
/*!
...
extern int __KAI_KMPC_CONVENTION omp_target_memcpy_async(void *, const void *,
                                                         size_t, size_t, size_t,
                                                         int, int, int,
                                                         omp_depend_t *);
extern int __KAI_KMPC_CONVENTION
omp_target_memcpy_rect_async(void *, const void *, size_t, int, const size_t *,
                             const size_t *, const size_t *, const size_t *,
                             const size_t *, int, int, int, omp_depend_t *);
extern void *__KAI_KMPC_CONVENTION omp_get_mapped_ptr(const void *, int);
extern int __KAI_KMPC_CONVENTION omp_target_is_accessible(const void *, size_t,
                                                          int);

/* OpenMP 6.0 device memory routines */
extern void *__KAI_KMPC_CONVENTION omp_target_memset(void *, int, size_t, int);
extern void *__KAI_KMPC_CONVENTION omp_target_memset_async(void *, int, size_t,
                                                           int, int,
                                                           omp_depend_t *);
...
{ omp_null_mem_space = 0,
  ...
  KMP_MEMSPACE_MAX_HANDLE = UINTPTR_MAX } omp_memspace_handle_t;
#endif
extern omp_allocator_handle_t __KAI_KMPC_CONVENTION omp_init_allocator(
  omp_memspace_handle_t m, int ntraits, omp_alloctrait_t traits[]);
extern void __KAI_KMPC_CONVENTION
omp_destroy_allocator(omp_allocator_handle_t allocator);

extern void __KAI_KMPC_CONVENTION
omp_set_default_allocator(omp_allocator_handle_t a);
extern omp_allocator_handle_t __KAI_KMPC_CONVENTION
omp_get_default_allocator(void);
#ifdef __cplusplus
extern void *__KAI_KMPC_CONVENTION
omp_alloc(size_t size, omp_allocator_handle_t a = omp_null_allocator);
extern void *__KAI_KMPC_CONVENTION omp_aligned_alloc(
  size_t align, size_t size, omp_allocator_handle_t a = omp_null_allocator);
extern void *__KAI_KMPC_CONVENTION omp_calloc(
  size_t nmemb, size_t size, omp_allocator_handle_t a = omp_null_allocator);
extern void *__KAI_KMPC_CONVENTION
omp_aligned_calloc(size_t align, size_t nmemb, size_t size,
                   omp_allocator_handle_t a = omp_null_allocator);
extern void *__KAI_KMPC_CONVENTION omp_realloc(
  void *ptr, size_t size, omp_allocator_handle_t allocator = omp_null_allocator,
  omp_allocator_handle_t free_allocator = omp_null_allocator);
extern void __KAI_KMPC_CONVENTION
omp_free(void *ptr, omp_allocator_handle_t a = omp_null_allocator);
#else
...
extern void *__KAI_KMPC_CONVENTION omp_calloc(size_t nmemb, size_t size,
                                              omp_allocator_handle_t a);
extern void *__KAI_KMPC_CONVENTION omp_aligned_calloc(size_t align,
...
omp_get_devices_memspace(int ndevs, const int *devs,
                         omp_memspace_handle_t memspace);
extern omp_memspace_handle_t
omp_get_device_memspace(int dev, omp_memspace_handle_t memspace);
extern omp_memspace_handle_t
omp_get_devices_and_host_memspace(int ndevs, const int *devs,
                                  omp_memspace_handle_t memspace);
extern omp_memspace_handle_t
omp_get_device_and_host_memspace(int dev, omp_memspace_handle_t memspace);
extern omp_memspace_handle_t
omp_get_devices_all_memspace(omp_memspace_handle_t memspace);
extern omp_allocator_handle_t
omp_get_devices_allocator(int ndevs, const int *devs,
                          omp_memspace_handle_t memspace);
extern omp_allocator_handle_t
omp_get_device_allocator(int dev, omp_memspace_handle_t memspace);
extern omp_allocator_handle_t
omp_get_devices_and_host_allocator(int ndevs, const int *devs,
                                   omp_memspace_handle_t memspace);
extern omp_allocator_handle_t
omp_get_device_and_host_allocator(int dev, omp_memspace_handle_t memspace);
extern omp_allocator_handle_t
omp_get_devices_all_allocator(omp_memspace_handle_t memspace);
extern int omp_get_memspace_num_resources(omp_memspace_handle_t memspace);
extern omp_memspace_handle_t omp_get_submemspace(omp_memspace_handle_t memspace,
                                                 int num_resources,
                                                 int *resources);
...
#if defined(_OPENMP) && defined(__clang__) && __clang_major__ > 11 &&          \
  !defined(__APPLE__)
...
extern void __KAI_KMPC_CONVENTION ompx_nbarrier_signal(uint32_t nbarrier_id,
...
extern void *__KAI_KMPC_CONVENTION ompx_target_realloc_device(void *, size_t,
                                                              int);
extern void *__KAI_KMPC_CONVENTION ompx_target_realloc_host(void *, size_t,
                                                            int);
extern void *__KAI_KMPC_CONVENTION ompx_target_realloc_shared(void *, size_t,
                                                              int);
extern void *__KAI_KMPC_CONVENTION ompx_target_aligned_alloc(size_t, size_t,
                                                             int);
extern void *__KAI_KMPC_CONVENTION ompx_target_aligned_alloc_device(size_t,
                                                                    size_t,
                                                                    int);
extern void *__KAI_KMPC_CONVENTION ompx_target_aligned_alloc_host(size_t,
                                                                  size_t, int);
extern void *__KAI_KMPC_CONVENTION ompx_target_aligned_alloc_shared(size_t,
                                                                    size_t,
                                                                    int);

/* Extension for subdevice access */
extern int __KAI_KMPC_CONVENTION ompx_get_num_subdevices(int device_num,
                                                         int level);

/* Extension for user-guided kernel batching */
extern void __KAI_KMPC_CONVENTION ompx_kernel_batch_begin(int device_num,
...
extern int __KAI_KMPC_CONVENTION ompx_get_device_info(int device_num,
                                                      int info_id,
                                                      size_t info_size,
                                                      void *info_value,
...
/* Note that these values are equivalent to L0 GPU RT definition except for
 * ompx_mem_hint_none */
enum kmp_mem_hint {
...
extern int __KAI_KMPC_CONVENTION
ompx_target_register_host_pointer(void *ptr, size_t size, int device_num);
extern void __KAI_KMPC_CONVENTION
ompx_target_unregister_host_pointer(void *ptr, int device_num);
...
/* Warning:
   The following typedefs are not standard, deprecated and will be removed in a
   future release.
*/
