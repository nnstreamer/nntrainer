...
GraphStatus mergeoutputImpl(TensorType &out_0, const TensorType &in_0,
                            const TensorType &in_1, const TensorType &in_2,
                            const TensorType &in_3, const Tensor &num);
 ...
 * DEF_PACKAGE_OP_AND_COST_AND_FLAGS((mergeoutputImpl<PlainFloatTensor>),
 * "MergeOutput", SNAIL)
 */
...

{
  ...
  const size_t dims[] = {b_in_0, h_in_0 + h_in_1 + h_in_2 + h_in_3 * 4, w_in_0,
                         d_in_0};
