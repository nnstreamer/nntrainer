...
GraphStatus wnopImpl(TensorType &out_0, TensorType1 &sync_var,
                     const TensorType &in_0, const TensorType &in_1,
 ...
 * DEF_PACKAGE_OP_AND_COST_AND_FLAGS((wnopImpl<PlainFloatTensor,
 * PlainFloatTensor>), "WNop", SNAIL)
 */
 ...
 * e.g. DEF_PACKAGE_OP_AND_COST_F_AND_FLAGS((wnopImpl<PlainFloatTensor,
 * PlainFloatTensor>), "WNop", wnopCostFunc, Flags::RESOURCE_HVX)
 */
