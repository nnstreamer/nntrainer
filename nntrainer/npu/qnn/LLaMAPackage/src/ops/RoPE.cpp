...
GraphStatus ropeImpl(TensorType &out_0, const TensorType &in_0,
 ...
 * DEF_PACKAGE_OP_AND_COST_AND_FLAGS((ropeImpl<PlainFloatTensor>), "RoPE",
 * SNAIL)
 */
...
int32_t hvx_rope_af(float *restrict input, float *restrict sin,
                    float *restrict cos, float *restrict output, uint32_t size,
      ...
      for (int32_t j = 0; j < size / partial_dimension; j++) {
        ...
        // auto value = in_value * cos_value - in_value_2 * sin_value;
        {
          HVX_Vector cos_middle_value_qf32 =
            Q6_Vqf32_vmpy_VsfVsf(sline1, cosline1);
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_VsfVsf(sline1_half, sinline1);
          *joptr = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vsub_Vqf32Vqf32(
            cos_middle_value_qf32, sin_middle_value_qf32));
        }

        // auto value2 = in_value * sin_value + in_value_2 * cos_value;
        {
          HVX_Vector cos_middle_value_qf32 =
            Q6_Vqf32_vmpy_VsfVsf(sline1_half, cosline1);
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_VsfVsf(sline1, sinline1);
          *joptr_half = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vqf32(
            cos_middle_value_qf32, sin_middle_value_qf32));
        }
  ...
  //   sum = Q6_Vqf32_vadd_Vqf32Vqf32(sum,  Q6_Vqf32_vmpy_VsfVsf(sline1,
  //   sline1));
...
int32_t hvx_rope_uint8_af(uint8_t *restrict input, float *restrict sin,
                          float *restrict cos, float *restrict output,
  ...
  for (int32_t i = vectors_in_rounddown - 1; i > 0; i -= BLOCK_SIZE) {
    ...
    for (int32_t j = 0; j < size / partial_dimension; j++) {
      ...
      HVX_VectorPair result1 =
        Q6_Wqf32_vmpy_VhfVhf(Q6_Vhf_equals_Vh(sout1), one_vec);
      result1 = Q6_W_vshuff_VVR(Q6_V_hi_W(result1), Q6_V_lo_W(result1), -4);

      HVX_VectorPair result2 =
        Q6_Wqf32_vmpy_VhfVhf(Q6_Vhf_equals_Vh(sout2), one_vec);
      result2 = Q6_W_vshuff_VVR(Q6_V_hi_W(result2), Q6_V_lo_W(result2), -4);

      // auto value = in_value * cos_value - in_value_2 * sin_value;
      {
        HVX_Vector cos_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result1), cosline1_low);
        HVX_Vector sin_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result2), sinline1_low);
        *optr = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vsub_Vqf32Vqf32(
          cos_middle_value_qf32, sin_middle_value_qf32));
      }
      ...
      {
        HVX_Vector cos_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result2), cosline1_low);
        HVX_Vector sin_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result1), sinline1_low);
        *(optr + 2) = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vqf32(
          cos_middle_value_qf32, sin_middle_value_qf32));
      }
      ...
      {
        HVX_Vector cos_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result1), cosline1_high);
        HVX_Vector sin_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result2), sinline1_high);
        *(optr + 1) = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vsub_Vqf32Vqf32(
          cos_middle_value_qf32, sin_middle_value_qf32));
      }
      ...
      {
        HVX_Vector cos_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result2), cosline1_high);
        HVX_Vector sin_middle_value_qf32 =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result1), sinline1_high);
        *(optr + 3) = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vadd_Vqf32Vqf32(
          cos_middle_value_qf32, sin_middle_value_qf32));
      }
...
int32_t hvx_rope_uint8_ahf(uint8_t *restrict input, float *restrict sin,
                           float *restrict cos, __fp16 *restrict output,
                           uint32_t size, uint32_t partial_dimension,
                           float scale) {
  if ((input == NULL) || (output == NULL) || (size == 0)) {
    return -1;
  ...
  for (int32_t i = vectors_in_rounddown - 1; i > 0; i -= BLOCK_SIZE) {
    ...
    for (int32_t j = 0; j < size / partial_dimension; j++) {
      ...
      HVX_VectorPair result1 =
        Q6_Wqf32_vmpy_VhfVhf(Q6_Vhf_equals_Vh(sout1), scale_vec);
      result1 = Q6_W_vshuff_VVR(Q6_V_hi_W(result1), Q6_V_lo_W(result1), -4);

      HVX_VectorPair result2 =
        Q6_Wqf32_vmpy_VhfVhf(Q6_Vhf_equals_Vh(sout2), scale_vec);
      result2 = Q6_W_vshuff_VVR(Q6_V_hi_W(result2), Q6_V_lo_W(result2), -4);

      {
        ...
        // auto value = in_value * cos_value - in_value_2 * sin_value;
        {
          ...
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result2), sinline1_low);
          first = Q6_Vqf32_vsub_Vqf32Vqf32(cos_middle_value_qf32,
                                           sin_middle_value_qf32);
        }
        ...
        // auto value = in_value * cos_value - in_value_2 * sin_value;
        {
          ...
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result2), sinline1_high);
          second = Q6_Vqf32_vsub_Vqf32Vqf32(cos_middle_value_qf32,
                                            sin_middle_value_qf32);
        }
...

      {
        ...
        // auto value2 = in_value * sin_value + in_value_2 * cos_value;
        {
          ...
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(result1), sinline1_low);
          first = Q6_Vqf32_vadd_Vqf32Vqf32(cos_middle_value_qf32,
                                           sin_middle_value_qf32);
        }
        ...
        // auto value2 = in_value * sin_value + in_value_2 * cos_value;
        {
          ...
          HVX_Vector sin_middle_value_qf32 =
            Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(result1), sinline1_high);
          second = Q6_Vqf32_vadd_Vqf32Vqf32(cos_middle_value_qf32,
                                            sin_middle_value_qf32);
        }
        HVX_Vector r = Q6_Vhf_equals_Wqf32(Q6_W_vcombine_VV(second, first));
        r = Q6_Vh_vdeal_Vh(r);
...
int32_t hvx_rope_ahf(__fp16 *restrict input, float *restrict sin,
                     float *restrict cos, __fp16 *restrict output,
                     uint32_t size, uint32_t partial_dimension) {
  if ((input == NULL) || (output == NULL) || (size == 0)) {
    return -1;
  ...
  for (int32_t i = vectors_in_rounddown - 1; i > 0; i -= BLOCK_SIZE) {
    ...
    for (int32_t d = 0; d < partial_dimension / 2; d += 64) {
      ...
      for (int32_t j = 0; j < size / partial_dimension; j++) {
        ...
        HVX_VectorPair sline1_half_pair =
          Q6_Wqf32_vmpy_VhfVhf(sline1_half, one_vhf);
        HVX_VectorPair sline1_pair = Q6_Wqf32_vmpy_VhfVhf(sline1, one_vhf);

        sline1_half_pair = Q6_W_vshuff_VVR(Q6_V_hi_W(sline1_half_pair),
                                           Q6_V_lo_W(sline1_half_pair), -4);
        sline1_pair =
          Q6_W_vshuff_VVR(Q6_V_hi_W(sline1_pair), Q6_V_lo_W(sline1_pair), -4);

        HVX_Vector m_sline1_half_low =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_lo_W(sline1_half_pair), m_one_vqf32);
        HVX_Vector m_sline1_half_hi =
          Q6_Vqf32_vmpy_Vqf32Vqf32(Q6_V_hi_W(sline1_half_pair), m_one_vqf32);

        // auto value = in_value * cos_value - in_value_2 * sin_value;
        HVX_Vector middle_value_low;
        {
          HVX_Vector cosline1_vqf32_low =
            Q6_Vqf32_vadd_VsfVsf(cosline1_low, Q6_V_vzero());
          HVX_Vector cos_middle_value_qf32_low = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_lo_W(sline1_pair), cosline1_vqf32_low);

          HVX_Vector sinline1_vqf32_low =
            Q6_Vqf32_vadd_VsfVsf(sinline1_low, Q6_V_vzero());

          HVX_Vector sin_middle_value_qf32_low =
            Q6_Vqf32_vmpy_Vqf32Vqf32(m_sline1_half_low, sinline1_vqf32_low);
          middle_value_low = Q6_Vqf32_vadd_Vqf32Vqf32(
            cos_middle_value_qf32_low, sin_middle_value_qf32_low);
        }
        ...
        HVX_Vector middle_value_half_low;
        {
          HVX_Vector cosline1_vqf32_low =
            Q6_Vqf32_vadd_VsfVsf(cosline1_low, Q6_V_vzero());
          HVX_Vector cos_middle_value_qf32_low = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_lo_W(sline1_half_pair), cosline1_vqf32_low);

          HVX_Vector sinline1_vqf32_low =
            Q6_Vqf32_vadd_VsfVsf(sinline1_low, Q6_V_vzero());
          HVX_Vector sin_middle_value_qf32_low = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_lo_W(sline1_pair), sinline1_vqf32_low);

          middle_value_half_low = Q6_Vqf32_vadd_Vqf32Vqf32(
            cos_middle_value_qf32_low, sin_middle_value_qf32_low);
        }
        ...
        {
          HVX_Vector cosline1_vqf32_high =
            Q6_Vqf32_vadd_VsfVsf(cosline1_high, Q6_V_vzero());
          HVX_Vector cos_middle_value_qf32_high = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_hi_W(sline1_pair), cosline1_vqf32_high);

          HVX_Vector sinline1_vqf32_high =
            Q6_Vqf32_vadd_VsfVsf(sinline1_high, Q6_V_vzero());

          HVX_Vector sin_middle_value_qf32_high =
            Q6_Vqf32_vmpy_Vqf32Vqf32(m_sline1_half_hi, sinline1_vqf32_high);
          middle_value_high = Q6_Vqf32_vadd_Vqf32Vqf32(
        ...
        HVX_Vector middle_value_half_high;
        {
          HVX_Vector cosline1_vqf32_high =
            Q6_Vqf32_vadd_VsfVsf(cosline1_high, Q6_V_vzero());
          HVX_Vector cos_middle_value_qf32_high = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_hi_W(sline1_half_pair), cosline1_vqf32_high);

          HVX_Vector sinline1_vqf32_high =
            Q6_Vqf32_vadd_VsfVsf(sinline1_high, Q6_V_vzero());
          HVX_Vector sin_middle_value_qf32_high = Q6_Vqf32_vmpy_Vqf32Vqf32(
            Q6_V_hi_W(sline1_pair), sinline1_vqf32_high);

          middle_value_half_high = Q6_Vqf32_vadd_Vqf32Vqf32(
            cos_middle_value_qf32_high, sin_middle_value_qf32_high);
        }

        HVX_Vector sline = Q6_Vhf_equals_Wqf32(
          Q6_W_vcombine_VV(middle_value_high, middle_value_low));
        sline = Q6_Vh_vdeal_Vh(sline);

        HVX_Vector sline_half = Q6_Vhf_equals_Wqf32(
          Q6_W_vcombine_VV(middle_value_half_high, middle_value_half_low));
    ...
    if (in_0.get_dtype() == DType::Float32 && dtype == DType::Float32) {
      ...
      for (Idx b = 0; b < b_in; b++) {
        for (Idx h = 0; h < h_in; h++) {
          ...
          hvx_rope_af(in_ptr, sin_ptr, cos_ptr, out_ptr, w_in * d_in,
                      partial_dimension);
      ...
      for (Idx b = 0; b < b_in; b++) {
        for (Idx h = 0; h < h_in; h++) {
          ...
          // for (Idx w = 0; w < w_in; w++) {
          hvx_rope_ahf(in_ptr, sin_ptr, cos_ptr, out_ptr, w_in * d_in,
                       partial_dimension);
      ...
      for (Idx b = 0; b < b_in; b++) {
        for (Idx h = 0; h < h_in; h++) {
          ...
          // for (Idx w = 0; w < w_in; w++) {
          hvx_rope_uint8_af(in_ptr, sin_ptr, cos_ptr, out_ptr, w_in * d_in,
                            partial_dimension);
      ...
      for (Idx b = 0; b < b_in; b++) {
        for (Idx h = 0; h < h_in; h++) {
          ...
          // for (Idx w = 0; w < w_in; w++) {
          hvx_rope_uint8_ahf(in_ptr, sin_ptr, cos_ptr, out_ptr, w_in * d_in,
                             partial_dimension, scale_);
...

{
  ...
  debuglog("RoPE execute... dims=(%zdx%zdx%zdx%zd)", in_0.dim(0), in_0.dim(1),
           in_0.dim(2), in_0.dim(3));
  debuglog("RoPE execute... dims=(%zdx%zdx%zdx%zd)", sin.dim(0), sin.dim(1),
           sin.dim(2), sin.dim(3));
  debuglog("RoPE execute... dims=(%zdx%zdx%zdx%zd)", cos.dim(0), cos.dim(1),
           cos.dim(2), cos.dim(3));
  ...
  //                           in_value_2 = -input->dataAt<float>(n, h, s, d +
  //                           input->dimension() / 2);
  //                       } else {
  //                           in_value_2 = input->dataAt<float>(n, h, s, d -
  //                           input->dimension() / 2);
  //                       }
  //                       float sin_value = sin_.dataAt<float>(0, 0, s +h_cnt_,
  //                       d); float cos_value = cos_.dataAt<float>(0, 0, s
  //                       +h_cnt_, d); auto value = in_value * cos_value +
  //                       in_value_2 * sin_value; if(output->dtypeAt(n,h,s, d)
  //                       == MLLM_TYPE_F32) {
  //                           output->setDataAt<float>(n, h, s, d, value);
  //                       }
  //                       else if(output->dtypeAt(n,h,s, d) == MLLM_TYPE_F16) {
  //                           output->setDataAt<mllm_fp16_t>(n, h, s, d,
  //                           MLLM_FP32_TO_FP16(value));
  //                       }
  //                   }
  //                   else if (pose_type_== 2) {
  //                       float in_value = input->dataAt<float>(n, h, s, d);
  ...
  //                       float sin_value = sin_.dataAt<float>(0, 0, s +h_cnt_,
  //                       d); float cos_value = cos_.dataAt<float>(0, 0, s
  //                       +h_cnt_, d); if (d < input->dimension() / 4) {
  //                           in_value_2 = - input->dataAt<float>(n, h, s, d +
  //                           input->dimension() / 4); auto value = in_value *
  //                           cos_value + in_value_2 * sin_value;
  //                           if(output->dtypeAt(n,h,s, d) == MLLM_TYPE_F32) {
  //                               output->setDataAt<float>(n, h, s, d, value);
  //                           }
  //                           else if(output->dtypeAt(n,h,s, d) ==
  //                           MLLM_TYPE_F16) {
  //                               output->setDataAt<mllm_fp16_t>(n, h, s, d,
  //                               MLLM_FP32_TO_FP16(value));
  //                           }
  ...
  //                       }else {
  //                           if(output->dtypeAt(n,h,s, d) == MLLM_TYPE_F32) {
  //                               output->setDataAt<float>(n, h, s, d,
  //                               in_value);
  //                           }
  //                           else if(output->dtypeAt(n,h,s, d) ==
  //                           MLLM_TYPE_F16) {
  //                               output->setDataAt<mllm_fp16_t>(n, h, s, d,
  //                               MLLM_FP32_TO_FP16(in_value));
  //                           }
  //                       }
  //                   }
  //               }
