...
private:
  ...
  std::function<void(void)> on_notify; /**< called when destroyed without error */
...
private:
  ...
  unsigned int num_being_filled;
  mutable std::mutex filled_mutex;
  std::condition_variable_any notify_emptied_cv;
