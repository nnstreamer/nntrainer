...
public:
   ...
   */
  NNTR_API IterationQueue(unsigned int num_slots,
   ...
   */
  NNTR_API ScopedView<Sample> requestEmptySlot();
   ...
   *
   */
  NNTR_API ScopedView<Iteration> requestFilledSlot();
   ...
   */
  NNTR_API unsigned int slots() { return iterations.size(); }
   ...
   */
  NNTR_API unsigned int batch() { return batch_size; }
   ...
   *
   */
  NNTR_API void notifyEndOfRequestEmpty();
...
private:
  ...
  public:
     ...
     */
    NNTR_API MarkableIteration(MarkableIteration &&rhs);
     ...
     */
    NNTR_API MarkableIteration &operator=(MarkableIteration &&rhs);

    /**
     * @brief mark iteration that one sample is filled
     * @todo make this function noexcept
     */
    NNTR_API void markSampleFilled() /** noexcept */;
     ...
     */
    NNTR_API Iteration &get() { return iteration; }
   ...
   */
  NNTR_API void markFilled(MarkableIteration *iteration) /** noexcept */;
   ...
   */
  NNTR_API void markEmpty(MarkableIteration *iteration) /** noexcept */;
