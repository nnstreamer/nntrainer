...
public:
   ...
   *
   */
  NNTR_API DataBuffer(std::unique_ptr<DataProducer> &&producer_);
   ...
   */
  NNTR_API std::future<std::shared_ptr<IterationQueue>>
   ...
   */
  NNTR_API ScopedView<Iteration> fetch();
   ...
   */
  NNTR_API std::tuple<DataProducer::Generator /**< callback */,
                      unsigned int /**< size */>
   ...
   * @retval void
   */
  NNTR_API void displayProgress(const int count, float loss);
   ...
   */
  NNTR_API const std::string getType() const;
   ...
   */
  NNTR_API bool isSerializable(const ml::train::ExportMethods &method) const;
