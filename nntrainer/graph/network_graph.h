...
public:
   ...
   */
  NNTR_API int compile(const std::string &loss_type);

  /**
   * @brief Create new LayerNode and add into Graph
   * @param[in] layer shared_ptr of Layer
   */
  NNTR_API void addLayer(std::shared_ptr<LayerNode> layer);
   ...
   * loader
   */
  NNTR_API std::vector<std::shared_ptr<LayerNode>>
   ...
   */
  NNTR_API unsigned int size() const { return graph.size(); }

  /**
   * @brief get if the graph is empty
   * @param[out] true if empty, else false
   */
  NNTR_API bool empty() const { return graph.empty(); }

  /**
   * @brief     Swap function for the class
   */
  NNTR_API friend void swap(NetworkGraph &lhs, NetworkGraph &rhs) {
   ...
   * @ret LayerNode
   */
  NNTR_API std::shared_ptr<LayerNode>
   ...
   */
  NNTR_API std::vector<std::shared_ptr<LayerNode>> getLayerNodes() const;

  /**
   * @brief     set batch size
   * @param[in] batch size
   */
  NNTR_API void setBatchSize(unsigned int batch_size);
   ...
   */
  NNTR_API void resetInputDimension(std::vector<TensorDim> dims);
   ...
   */
  NNTR_API graph_const_iterator<LayerNode> cbegin() const {
   ...
   * @retval    const iterator
   */
  NNTR_API graph_const_iterator<LayerNode> cend() const {
   ...
   */
  NNTR_API graph_const_reverse_iterator<LayerNode> crbegin() const {
   ...
   * @retval    const reverse iterator
   */
  NNTR_API graph_const_reverse_iterator<LayerNode> crend() const {
   ...
   */
  NNTR_API graph_const_reverse_iterator<LayerNode>
   ...
   */
  NNTR_API std::vector<TensorDim> getOutputDimension() const;

  /**
   * @brief     getter of input dimension of graph
   * @retval    input tensor dim list
   */
  NNTR_API std::vector<TensorDim> getInputDimension() const;
   ...
   * @return unsigned int
   */
  NNTR_API unsigned int getBatchSize() const;
   ...
   */
  NNTR_API NetworkGraph &copy(NetworkGraph &from) {
   ...
   */
  NNTR_API void allocateTensors(ExecutionMode exec_mode_);
   ...
   */
  NNTR_API void allocateWeights(bool init = true) {
   ...
   */
  NNTR_API void deallocateWeights() { tensor_manager->deallocateWeights(); }
   ...
   */
  NNTR_API void setMemoryOptimizations(bool val) {
   ...
   */
  NNTR_API void requestOptimizerVariable(
   ...
   */
  NNTR_API void setInputsLabels(const std::vector<Tensor> &inputs,
   ...
   * @param labels Label data
   */
  NNTR_API void setInputsLabels(sharedConstTensors &inputs,
   ...
   */
  NNTR_API std::vector<Tensor> getOutputTensors() const;
   ...
   */
  NNTR_API std::array<std::string, 3> getTensorType() {
   ...
   */
  NNTR_API void flushCacheExcept(const unsigned int order);
   ...
   */
  NNTR_API void LoadTensors(const unsigned int order,
   ...
   * @param order execution order
   */
  NNTR_API bool checkLoadComplete(const unsigned int order);

  /**
   * @brief inactive the elem
   *
   */
  NNTR_API bool inActive(unsigned int order);
   ...
   * @param order execution order
   */
  NNTR_API bool checkUnloadComplete(const unsigned int order);
   ...
   * @param order execution order
   */
  NNTR_API void UnloadTensors(const unsigned int order);
   ...
   * @param[in] scale
   */
  NNTR_API void resetLossScale(float scale);
   ...
   */
  NNTR_API void setFsuWeightPath(const std::string &path) {
