...
public:
   ...
   *
   */
  NNTR_API  virtual ~MemoryPool() { deallocate(); }
   ...
   */
  NNTR_API double planLayout(const MemoryPlanner &planner);

  /**
   * @brief Do the allocation of memory
   *
   */
 NNTR_API  virtual void allocate();

  /**
   * @brief Do the allocation of memory for FSU
   *
   */
 NNTR_API  virtual void allocateFSU();
   ...
   */
 NNTR_API  virtual std::shared_ptr<MemoryData> getMemory(unsigned int idx);

  /**
   * @brief Free all the allocated memory
   *
   */
 NNTR_API  virtual void deallocate();
...
NNTR_API   virtual void clear();
   ...
   */
 NNTR_API  virtual bool isAllocated() const;
   ...
   */
 NNTR_API  std::vector<void *> getMemoryPtrs() { return memory_ptrs; }
   ...
   */
 NNTR_API  void *getMemoryPoolAddress() { return mem_pool; }
   ...
   */
  NNTR_API virtual void setFsuWeightPath(std::string path){};
