/**
 * @file kai_rhs_pack_kxn_qsi4cxp_qs4cxs1s0.c
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_rhs_pack_kxn_qsi4cxp_qs4cxs1s0.c
...
size_t kai_get_n_step_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(size_t nr) { return nr; }

size_t kai_get_rhs_offset_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(size_t n_idx,
                                                         size_t rhs_stride) {
...
size_t kai_get_rhs_packed_stride_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(size_t k,
                                                                size_t nr,
                                                                size_t kr,
                                                                size_t sr) {
  KAI_UNUSED(kr);
  ...
  return nr * ((k_internal / 2) + kai_num_bytes_multiplier_rhs +
...
size_t kai_get_rhs_packed_offset_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(
  ...
  return (n_idx / nr) *
         kai_get_rhs_packed_stride_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(k, nr, kr,
                                                                  sr);
}

size_t kai_get_rhs_packed_size_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(
  size_t n, size_t k, size_t nr, size_t kr, size_t sr) {
  const size_t num_rows = kai_roundup(n, nr) / nr;

  return num_rows * kai_get_rhs_packed_stride_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(
                      k, nr, kr, sr);
}
...
void kai_run_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(
  ...
  const size_t rhs_packed_stride =
    kai_get_rhs_packed_stride_rhs_pack_kxn_qsi4cxp_qs4cxs1s0(k, nr, kr, sr);
  const size_t k_internal = kai_k_roundedup(k);
    ...
    for (size_t dst_byte_idx = 0; dst_byte_idx < dst_num_bytes_per_row;
      ...
      if (params->rhs_zero_point == 8) {
        ...
        */
        ...
        sums[nr_idx] +=
          (int32_t)src_x0_lo + (int32_t)src_x0_hi - 2 * (int32_t)rhs_zero_point;
