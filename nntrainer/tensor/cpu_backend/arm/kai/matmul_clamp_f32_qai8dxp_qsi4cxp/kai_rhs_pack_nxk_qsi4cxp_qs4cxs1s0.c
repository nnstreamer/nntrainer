/**
 * @file kai_rhs_pack_nxk_qsi4cxp_qs4cxs1s0.c
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_rhs_pack_nxk_qsi4cxp_qs4cxs1s0.c
...
size_t kai_get_n_step_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(size_t nr) { return nr; }

size_t kai_get_rhs_offset_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(size_t n_idx,
                                                         size_t rhs_stride) {
  return n_idx * rhs_stride;
}

size_t kai_get_rhs_packed_stride_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(size_t k,
                                                                size_t nr,
                                                                size_t kr,
                                                                size_t sr) {
  KAI_UNUSED(kr);
...
size_t kai_get_rhs_packed_offset_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(
  ...
  return (n_idx / nr) *
         kai_get_rhs_packed_stride_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(k, nr, kr,
                                                                  sr);
}

size_t kai_get_rhs_packed_size_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(
  size_t n, size_t k, size_t nr, size_t kr, size_t sr) {
  const size_t num_rows = kai_roundup(n, nr) / nr;

  return num_rows * kai_get_rhs_packed_stride_rhs_pack_nxk_qsi4cxp_qs4cxs1s0(
                      k, nr, kr, sr);
}
