/**
 * @file kai_matmul_clamp_f32_qai8dxp1x8_qsi4cxp8x8_1x8x32_neon_dotprod.c
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_matmul_clamp_f32_qai8dxp1x8_qsi4cxp8x8_1x8x32_neon_dotprod.c
...
void kai_run_matmul_clamp_f32_qai8dxp1x8_qsi4cxp8x8_1x8x32_neon_dotprod(
  ...
  __asm__ __volatile__(
    ...
    : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v16", "v17", "v18",
      ...
      "v29", "v30", "v31", "x20", "x21", "x22", "x23", "x24", "x25", "x26");
}
