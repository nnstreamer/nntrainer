/**
 * @file kai_matmul_clamp_f32_qai8dxp4x8_qsi4cxp4x8_4x8x32_neon_i8mm.h
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_matmul_clamp_f32_qai8dxp4x8_qsi4cxp4x8_4x8x32_neon_i8mm.h
...
size_t
kai_get_m_step_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_4x8x32_neon_i8mm(void);
...
/// @return the n step
size_t
kai_get_n_step_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_4x8x32_neon_i8mm(void);
...
/// which contains the packed 4-bit quantized symmetric per-channel (qsu4cx)
/// values.
///
...
/// of 4.
/// @param[in] n_idx      Column index in the DST matrix. It must be a multiple
/// of 8.
...
size_t kai_get_dst_size_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_4x8x32_neon_i8mm(
  size_t m, size_t n);
...
/// RHS matrix: Signed 4-bit quantized symmetric per-channel (qsu4cx) and
/// packed. Output tile: (rows x cols) = 4 x 8 Accumulation performed in a
/// single for loop: 32 Instruction used: i8mm
///
/// @param[in]  m              The number of output rows written.
/// @param[in]  n              The number of output columns written.
/// @param[in]  k              The number of channels. The common dimension of
/// LHS & RHS.
...
/// @param[in]  rhs_packed     The RHS matrix packed, which is obtained by
/// calling @ref kai_run_rhs_pack_nxk_qsi4cxp_qs4cxs1s0
...
/// matrix. For now, it must be sizeof(float)
