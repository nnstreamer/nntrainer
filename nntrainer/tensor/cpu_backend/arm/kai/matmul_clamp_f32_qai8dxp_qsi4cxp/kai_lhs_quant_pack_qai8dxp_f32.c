/**
 * @file kai_lhs_quant_pack_qai8dxp_f32.c
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_lhs_quant_pack_qai8dxp_f32.c copied from kleidiai
 *
 */
//
...
size_t kai_get_lhs_offset_lhs_quant_pack_qai8dxp_f32(size_t m_idx,
                                                     size_t lhs_stride) {
  return m_idx * lhs_stride;
}

size_t kai_get_lhs_packed_offset_lhs_quant_pack_qai8dxp_f32(size_t m_idx,
                                                            size_t k, size_t mr,
                                                            size_t kr,
                                                            size_t sr) {
...
size_t kai_get_lhs_packed_size_lhs_quant_pack_qai8dxp_f32(size_t m, size_t k,
                                                          size_t mr, size_t kr,
                                                          size_t sr) {
...
void kai_run_lhs_quant_pack_qai8dxp_f32(
  ...
  const float *restrict lhs, size_t lhs_stride, void *restrict lhs_packed) {
  KAI_ASSERT((kr % sr) == 0);
