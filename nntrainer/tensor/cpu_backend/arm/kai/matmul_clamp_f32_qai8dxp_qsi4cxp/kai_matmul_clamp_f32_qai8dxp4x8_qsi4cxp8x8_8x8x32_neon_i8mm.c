/**
 * @file kai_matmul_clamp_f32_qai8dxp4x8_qsi4cxp4x8_8x8x32_neon_i8mm.c
 * @date   22 Septemer 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  kai_matmul_clamp_f32_qai8dxp4x8_qsi4cxp4x8_8x8x32_neon_i8mm.c
...
size_t
kai_get_mr_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_8x8x32_neon_i8mm(void) {
  return kai_mr;
}

size_t
kai_get_nr_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_8x8x32_neon_i8mm(void) {
  return kai_nr;
}

size_t
kai_get_kr_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_8x8x32_neon_i8mm(void) {
  return kai_kr;
}

size_t
kai_get_sr_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_8x8x32_neon_i8mm(void) {
  return kai_sr;
}
...
void kai_run_matmul_clamp_f32_qai8dxp4x8_qsi4cxp8x8_8x8x32_neon_i8mm(
  ...
  __asm__ __volatile__(
    ...
    : "cc", "memory", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8",
      ...
      "v29", "v30", "v31", "x9", "x10", "x11", "x12", "x20", "x21", "x22",
