 ...
 */
NNTR_API void __fallback_calc_trigonometric_vals_dup(unsigned int N_half,
                                                     float *angle, float *cos_,
                                                     float *sin_,
 ...
 */
NNTR_API void __fallback_swiglu(const unsigned int N, float *X, float *Y,
                                float *Z);
 ...
 */
NNTR_API float __fallback_max(const unsigned int N, float *X);
 ...
 * @param Y  float * for Vector Y
 */
NNTR_API void __fallback_softmax(const unsigned int N, float *X, float *Y);
 ...
 * @param[out] bool false if not valide else true
 */
NNTR_API bool __fallback_isValid(const unsigned int N, const float *X);
 ...
 * @param ld_dst data offset of output matrix
 */
NNTR_API void __fallback_transpose_matrix(const unsigned int M,
 ...
 * @param[in] alpha float number
 */
NNTR_API void __fallback_sscal(const unsigned int N, const float alpha,
 ...
 * @param[in] X float * for Vector X
 */
NNTR_API float __fallback_snrm2(const unsigned int N, const float *X,
                                const unsigned int incX);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 */
NNTR_API void __fallback_copy_s16(const unsigned int N, const int16_t *X,
                                  int16_t *Y);
 ...
 */
NNTR_API void __fallback_copy_u16(const unsigned int N, const uint16_t *X,
                                  uint16_t *Y);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_copy_s16_fp32(const unsigned int N, const int16_t *X,
                                       float *Y);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_copy_u16_fp32(const unsigned int N, const uint16_t *X,
                                       float *Y);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 */
NNTR_API void __fallback_copy_fp32_u32(const unsigned int N, const float *X,
                                       uint32_t *Y);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 * @param[in] Y uint16_t * for Vector Y
 */
NNTR_API void __fallback_copy_fp32_u16(const unsigned int N, const float *X,
                                       uint16_t *Y);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 */
NNTR_API void __fallback_copy_fp32_u8(const unsigned int N, const float *X,
                                      uint8_t *Y);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 * @param[in] Y int16_t * for Vector Y
 */
NNTR_API void __fallback_copy_fp32_s16(const unsigned int N, const float *X,
                                       int16_t *Y);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 */
NNTR_API void __fallback_copy_fp32_s8(const unsigned int N, const float *X,
                                      int8_t *Y);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_scopy(const unsigned int N, const float *X,
                               const unsigned int incX, float *Y,
                               const unsigned int incY);
/**
 * @brief     copy function : Y = X
 ...
 * @param[in] Y uint8_t * for Vector Y
 */
NNTR_API void __fallback_scopy(const unsigned int N, const uint8_t *X,
 ...
 * @param[in] Y int8_t * for Vector Y
 */
NNTR_API void __fallback_scopy(const unsigned int N, const int8_t *X,
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_scopy_int4_to_float32(const unsigned int N,
                                               const uint8_t *X,
                                               const unsigned int incX,
                                               float *Y,
                                               const unsigned int incY);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_scopy_uint8_to_float32(const unsigned int N,
                                                const uint8_t *X,
                                                const unsigned int incX,
                                                float *Y,
                                                const unsigned int incY);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_scopy_int8_to_float32(const unsigned int N,
                                               const int8_t *X,
                                               const unsigned int incX,
                                               float *Y,
                                               const unsigned int incY);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API float __fallback_sdot(const unsigned int N, const float *X,
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void __fallback_saxpy(const unsigned int N, const float alpha,
 ...
 * @param[in] beta float number
 */
NNTR_API void __fallback_sgemm(const unsigned int TStorageOrder, bool TransA,
 ...
 * @param[in] beta float number
 */
NNTR_API void __fallback_sgemv(const unsigned int TStorageOrder, bool TransA,
                               const unsigned int M, const unsigned int N,
                               const float alpha, const float *A,
 ...
 * @param[in] X float * for Vector X
 */
NNTR_API unsigned int __fallback_isamax(const unsigned int N, const float *X,
                                        const unsigned int incX);
 ...
 */
NNTR_API void __fallback_sine(const unsigned int N, float *X, float *Y,
                              float alpha);
 ...
 * @param[in] alpha float * for scaling angle (radian)
 */
NNTR_API void __fallback_cosine(const unsigned int N, float *X, float *Y,
                                float alpha);
 ...
 * @param X float * for Vector X
 */
NNTR_API void __fallback_inv_sqrt_inplace(const unsigned int N, float *X);
/**
 * @brief     elementwise vector multiplication : Z = X ⊙ alpha * Y +
 * beta * Z
 * @param[in] N  length of the vector
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void __fallback_ele_mul(const unsigned int N, const float *X,
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void __fallback_ele_add(const unsigned int N, const float *X,
                                 const float *Y, float *Z, float alpha,
                                 float beta, unsigned int i_stride,
                                 unsigned int o_stride);
/**
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void __fallback_ele_sub(const unsigned N, const float *X,
                                 const float *Y, float *Z, float alpha,
                                 float beta, unsigned int i_stride,
                                 unsigned int o_stride);
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void __fallback_ele_div(const unsigned N, const float *X,
                                 const float *Y, float *Z, float alpha,
                                 float beta, unsigned int i_stride,
                                 unsigned int o_stride);
 ...
 */
NNTR_API void __fallback_gemm_q4_0(const unsigned int M, const unsigned int N,
 ...
 * @param ldc Leading dimension of C
 */
NNTR_API void __fallback_gemm_q4_K(const unsigned int M, const unsigned int N,
                                   const unsigned int K, const float *A,
                                   const unsigned int lda, const void *B,
                                   const unsigned int ldb, float *C,
                                   const unsigned int ldc);
 ...
 * @param ldc Leading dimension of C
 */
NNTR_API void __fallback_gemm_q6_K(const unsigned int M, const unsigned int N,
                                   const unsigned int K, const float *A,
                                   const unsigned int lda, const void *B,
                                   const unsigned int ldb, float *C,
                                   const unsigned int ldc);
 ...
 */
NNTR_API float __fallback_dot_q6_K_q8_K(const unsigned int K,
                                        const void *v_q6_K, const void *v_q8_K);
 ...
 */
NNTR_API float __fallback_dot_q6_K_f32(const unsigned int K, const void *v_q6_K,
                                       const float *f);
 ...
 */
NNTR_API size_t __fallback_quantize_q4_0(const float *src, void *dst,
 ...
 * @return size_t size of total quantized data in bytes
 */
NNTR_API size_t __fallback_quantize_q4_K(const float *src, void *dst,
                                         int64_t nrow, int64_t n_per_row,
                                         const float *quant_weights);
/**
 ...
 * @return size_t size of total quantized data in bytes
 */
NNTR_API size_t __fallback_quantize_q6_K(const float *src, void *dst,
                                         int64_t nrow, int64_t n_per_row,
                                         const float *quant_weights);
 ...
 */
NNTR_API void __fallback_quantize_row_q6_K(const float *src, void *dst,
                                           int64_t k);
 ...
 * @param k number of elements in src
 */
NNTR_API void __fallback_quantize_row_q8_K(const float *src, void *dst,
                                           int64_t k);
 ...
 */
NNTR_API void __fallback_dequantize_row_q4_K(const void *x_raw, float *y,
                                             int64_t k);
 ...
 * @param k number of elements in x
 */
NNTR_API void __fallback_dequantize_row_q6_K(const void *x, float *y,
                                             int64_t k);
 ...
 * @param k number of elements in x
 */
NNTR_API void __fallback_dequantize_row_q8_K(const void *x, float *y,
                                             int64_t k);
 ...
 */
NNTR_API void __fallback_repack_q4_0_to_q4_0_8(void *W, void *repacked_W,
                                               size_t data_size,
 ...
 * @param N number of columns
 */
NNTR_API void __fallback_repack_q4_K_to_q4_K_8(void *W, void *repacked_W,
                                               size_t data_size,
                                               const unsigned int M,
                                               const unsigned int N);
