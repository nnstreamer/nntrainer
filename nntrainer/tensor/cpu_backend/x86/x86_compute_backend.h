 ...
 */
NNTR_API void calc_trigonometric_vals_dup(unsigned int N_half, float *angle,
                                          float *cos_, float *sin_,
 ...
 */
NNTR_API void swiglu(const unsigned int N, float *X, float *Y, float *Z);
 ...
 */
NNTR_API float max_val(const unsigned int N, float *X);
 ...
 * @param Y  float * for Vector Y
 */
NNTR_API void softmax(const unsigned int N, float *X, float *Y);
/**
 * @brief Matrix transpose / 2D Tensor transpose
 *
 * @param M row length of input matrix
 ...
 * @param ld_dst data offset of output matrix
 */
NNTR_API void transpose_matrix(const unsigned int M, const unsigned int N,
 ...
 * @param[in] alpha float number
 */
NNTR_API void sscal(const unsigned int N, const float alpha, float *X,
                    const unsigned int incX);
/**
 * @brief     snrm2 computation : Euclidean norm
 * @param[in] N number of elements in X
 * @param[in] X float * for Vector X
 */
NNTR_API float snrm2(const unsigned int N, const float *X,
                     const unsigned int incX);
/**
 * @brief     copy function : Y = X
 * @param[in] N number of elements in X
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void scopy(const unsigned int N, const float *X,
 ...
 */
NNTR_API void scopy(const unsigned int N, const uint8_t *X,
 ...
 */
NNTR_API void scopy(const unsigned int N, const int8_t *X,
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void scopy_int4_to_float32(const unsigned int N, const uint8_t *X,
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void copy_s16_fp32(const unsigned int N, const int16_t *X, float *Y);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void copy_u16_fp32(const unsigned int N, const uint16_t *X, float *Y);
 ...
 */
NNTR_API void copy_fp32_u32(const unsigned int N, const float *X, uint32_t *Y);
 ...
 */
NNTR_API void copy_fp32_u16(const unsigned int N, const float *X, uint16_t *Y);
 ...
 * @param[in] Y uint8_t * for Vector Y
 */
NNTR_API void copy_fp32_u8(const unsigned int N, const float *X, uint8_t *Y);
 ...
 */
NNTR_API void copy_fp32_s16(const unsigned int N, const float *X, int16_t *Y);
 ...
 * @param[in] Y int8_t * for Vector Y
 */
NNTR_API void copy_fp32_s8(const unsigned int N, const float *X, int8_t *Y);
 ...
 */
template <typename T>
NNTR_API void copy_fp32(const unsigned int N, const float *X, T *Y);
 ...
 */
template <typename T>
NNTR_API inline void copy_fp32(const unsigned int N, const float *X, T *Y) {
 ...
 */
template <>
NNTR_API inline void copy_fp32<uint32_t>(const unsigned int N, const float *X,
                                         uint32_t *Y) {
  copy_fp32_u32(N, X, Y);
}
 ...
 */
template <>
NNTR_API inline void copy_fp32<uint16_t>(const unsigned int N, const float *X,
                                         uint16_t *Y) {
  copy_fp32_u16(N, X, Y);
}
 ...
 */
template <>
NNTR_API inline void copy_fp32<uint8_t>(const unsigned int N, const float *X,
                                        uint8_t *Y) {
  copy_fp32_u8(N, X, Y);
}
 ...
 */
template <>
NNTR_API inline void copy_fp32<int16_t>(const unsigned int N, const float *X,
                                        int16_t *Y) {
  copy_fp32_s16(N, X, Y);
}
 ...
 */
template <>
NNTR_API inline void copy_fp32<int8_t>(const unsigned int N, const float *X,
                                       int8_t *Y) {
  copy_fp32_s8(N, X, Y);
}
 ...
 * @param[in] Y int16_t * for Vector Y
 */
NNTR_API void copy_s16(const unsigned int N, const int16_t *X, int16_t *Y);
 ...
 * @param[in] Y uint16_t * for Vector Y
 */
NNTR_API void copy_u16(const unsigned int N, const uint16_t *X, uint16_t *Y);
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void scopy_int8_to_float32(const unsigned int N, const uint8_t *X,
                                    const unsigned int incX, float *Y,
                                    const unsigned int incY);
/**
 * @brief     copy function : Y = X
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void scopy_int8_to_float32(const unsigned int N, const int8_t *X,
                                    const unsigned int incX, float *Y,
                                    const unsigned int incY);
/**
 * @brief     sdot computation : sum of all X * Y
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API float sdot(const unsigned int N, const float *X,
 ...
 * @param[in] Y float * for Vector Y
 */
NNTR_API void saxpy(const unsigned int N, const float alpha, const float *X,
                    const unsigned int incX, float *Y, const unsigned int incY);
/**
 * @brief     sgemm computation  : Y = alpha*op(A)*op(B) + beta*C,
 * where op(X) is one of X or X**T
 ...
 * @param[in] beta float number
 */
NNTR_API void sgemm(const unsigned int TStorageOrder, bool TransA, bool TransB,
 ...
 * @param[in] beta float number
 */
NNTR_API void sgemv(const unsigned int TStorageOrder, bool TransA,
                    const unsigned int M, const unsigned int N,
 ...
 * @param[in] X float * for Vector X
 */
NNTR_API unsigned int isamax(const unsigned int N, const float *X,
                             const unsigned int incX);
 ...
 */
NNTR_API void sine(const unsigned int N, float *X, float *Y, float alpha = 1.f);
 ...
 * @param[in] alpha float * for scaling angle (radian)
 */
NNTR_API void cosine(const unsigned int N, float *X, float *Y,
                     float alpha = 1.f);
 ...
 * @param X float * for Vector X
 */
NNTR_API void inv_sqrt_inplace(const unsigned int N, float *X);
/**
 * @brief     elementwise vector multiplication : Z = X ⊙ alpha * Y +
 * beta * Z
 * @param[in] N  length of the vector
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void ele_mul(const unsigned int N, const float *X, const float *Y,
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void ele_add(const unsigned int N, const float *X, const float *Y,
                      float *Z, float alpha = 1.f, float beta = 0.f,
                      unsigned int i_stride = 1, unsigned int o_stride = 1);
/**
 * @brief     elementwise vector subtraction with neon : Z = X - alpha * Y +
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void ele_sub(const unsigned N, const float *X, const float *Y,
                      float *Z, float alpha = 1.f, float beta = 0.f,
                      unsigned int i_stride = 1, unsigned int o_stride = 1);
 ...
 * @param[in] o_stride output stride
 */
NNTR_API void ele_div(const unsigned N, const float *X, const float *Y,
                      float *Z, float alpha = 1.f, float beta = 0.f,
                      unsigned int i_stride = 1, unsigned int o_stride = 1);
 ...
 * @param[out] bool false if not valid else true
 */
NNTR_API bool is_valid(const unsigned int N, const float *X);
 ...
 */
NNTR_API void gemm_q4_0(const unsigned int M, const unsigned int N,
 ...
 * @param ldc Leading dimension of C
 */
NNTR_API void gemm_q4_K(const unsigned int M, const unsigned int N,
                        const unsigned int K, const float *A,
                        const unsigned int lda, const void *B,
                        const unsigned int ldb, float *C,
                        const unsigned int ldc);
 ...
 * @param ldc Leading dimension of C
 */
NNTR_API void gemm_q6_K(const unsigned int M, const unsigned int N,
                        const unsigned int K, const float *A,
                        const unsigned int lda, const void *B,
                        const unsigned int ldb, float *C,
                        const unsigned int ldc);
 ...
 */
NNTR_API float dot_q6_K_q8_K(const unsigned int K, const void *v_q6_K,
                             const void *v_q8_K);
/**
 ...
 */
NNTR_API float dot_q6_K_f32(const unsigned int K, const void *v_q6_K,
                            const float *f);
 ...
 */
NNTR_API size_t quantize_q4_0(const float *src, void *dst, int64_t nrow,
 ...
 * @return size_t size of total quantized data in bytes
 */
NNTR_API size_t quantize_q4_K(const float *src, void *dst, int64_t nrow,
                              int64_t n_per_row, const float *quant_weights);
/**
 ...
 * @return size_t size of total quantized data in bytes
 */
NNTR_API size_t quantize_q6_K(const float *src, void *dst, int64_t nrow,
                              int64_t n_per_row, const float *quant_weights);
 ...
 */
NNTR_API void quantize_row_q6_K(const float *src, void *dst, int64_t k);
 ...
 * @param k number of elements in src
 */
NNTR_API void quantize_row_q8_K(const float *src, void *dst, int64_t k);
 ...
 */
NNTR_API void dequantize_row_q4_K(const void *x, float *y, int64_t k);
 ...
 * @param k number of elements in x
 */
NNTR_API void dequantize_row_q6_K(const void *x, float *y, int64_t k);
 ...
 * @param k number of elements in x
 */
NNTR_API void dequantize_row_q8_K(const void *x, float *y, int64_t k);
 ...
 */
NNTR_API void repack_q4_0_to_q4_0_8(void *W, void *repacked_W, size_t data_size,
                                    const unsigned int M, const unsigned int N);
 ...
 * @param N number of columns
 */
NNTR_API void repack_q4_K_to_q4_K_8(void *W, void *repacked_W, size_t data_size,
                                    const unsigned int M, const unsigned int N);
