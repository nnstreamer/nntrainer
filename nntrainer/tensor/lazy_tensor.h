...
public:
   ...
   * immutability
   */
  NNTR_EXPORT LazyTensor(const Tensor &from) { target.copy(from); };
   ...
   */
  NNTR_EXPORT LazyTensor &add_i(float const &value);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &add_i(Tensor const &m, float const alpha = 1);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &subtract_i(Tensor const &m);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &subtract_i(float const &value);
   ...
   * @retval LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &multiply_i(float const &value);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &multiply_i(Tensor const &m);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &divide_i(float const &value);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &divide_i(Tensor const &m);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &dot(Tensor const &m);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &transpose(std::string direction);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &sum_by_batch();
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &sum(int axis);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &average(int axis);
   ...
   * @retval    LazyTensor *this
   */
  NNTR_EXPORT LazyTensor &average();

  /**
   * @brief execute the call_chain to get the tensor
   * @retval calculated tensor
   */
  NNTR_EXPORT Tensor run();
