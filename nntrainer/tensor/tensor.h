...
public:
   ...
   */
  NNTR_EXPORT Tensor(std::string name_ = "", Tformat fm = Tformat::NCHW,
   ...
   */
  NNTR_EXPORT Tensor(const TensorDim &d, bool alloc_now,
   ...
   */
  NNTR_EXPORT Tensor(const TensorDim &d, const void *buf = nullptr,
                     QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE);
   ...
   */
  NNTR_EXPORT Tensor(size_t d0, size_t d1, size_t d2, size_t d3,
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(size_t d1, size_t d2, size_t d3,
                     Tformat fm = Tformat::NCHW,
                     Tdatatype d_type = Tdatatype::FP32,
                     QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(size_t d2, size_t d3, Tformat fm = Tformat::NCHW,
                     Tdatatype d_type = Tdatatype::FP32,
                     QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT explicit Tensor(size_t d3, Tformat fm = Tformat::NCHW,
                              Tdatatype d_type = Tdatatype::FP32,
                              QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(size_t d2, size_t d3,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT explicit Tensor(size_t d3,
                              ml::train::TensorDim::TensorType t_type,
                              QScheme qscheme_ = QScheme::PER_TENSOR_AFFINE) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<float>>> const &d,
                     ml::train::TensorDim::TensorType t_type) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<float>> const &d,
                     ml::train::TensorDim::TensorType t_type) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, t_type){};
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<_FP16>>> const &d,
                     ml::train::TensorDim::TensorType t_type) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, t_type){};
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<_FP16>> const &d,
                     ml::train::TensorDim::TensorType t_type) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, t_type){};
#endif
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<uint8_t>>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<uint8_t>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<uint16_t>>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<uint16_t>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<uint32_t>>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] t_type Tensor Type
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<uint32_t>> const &d,
                     std::vector<float> const &scales,
                     std::vector<unsigned int> const &zero_points,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<int8_t>>> const &d,
                     std::vector<float> const &scales,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<int8_t>> const &d,
                     std::vector<float> const &scales,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, scales, t_type,
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<std::vector<int16_t>>> const &d,
                     std::vector<float> const &scales,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, scales, t_type,
   ...
   * @param[in] qscheme_ Quantization scheme (only applies to Quantized Tensor)
   */
  NNTR_EXPORT Tensor(std::vector<std::vector<int16_t>> const &d,
                     std::vector<float> const &scales,
                     ml::train::TensorDim::TensorType t_type,
                     QScheme qscheme_) :
    Tensor(std::vector<std::decay<decltype(d)>::type>{d}, scales, t_type,
   ...
   *  constructor.
   */
  NNTR_EXPORT Tensor(const std::unique_ptr<TensorBase> &rhs);

  /**
   * @brief Basic Destructor
   */
  NNTR_EXPORT ~Tensor() = default;

  /**
   *  @brief  Copy constructor of Tensor.
   *  @param[in] Tensor &
   */
  NNTR_EXPORT Tensor(const Tensor &rhs);

  /**
   *  @brief  Move constructor of Tensor.
   *  @param[in] Tensor &&
   */
  NNTR_EXPORT Tensor(Tensor &&rhs) noexcept = default;

  /**
   * @brief  Copy assignment operator.
   * @param[in] rhs Tensor to be copied.
   */
  NNTR_EXPORT Tensor &operator=(const Tensor &rhs);

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs Tensor to be moved.
   */
  NNTR_EXPORT Tensor &operator=(Tensor &&rhs) noexcept = default;

  /**
   * @brief     Comparison operator overload
   * @param[in] rhs Tensor to be compared with
   */
  NNTR_EXPORT bool operator==(const Tensor &rhs) const;
   ...
   */
  template <typename T>
  NNTR_EXPORT static bool itensorCompare(const TensorBase *lhs,
  ...
  NNTR_EXPORT static Tensor Map(T *buf, unsigned int bytes, const TensorDim &d,
                                size_t offset = 0) {
   ...
   */
  NNTR_EXPORT bool isAllocated();

  /**
   * @brief     return Data pointer of Tensor
   * @retval    template T pointer
   */
  template <typename T = float> NNTR_EXPORT T *getData() const {
   ...
   * @retval    template T pointer
   */
  template <typename T = float> NNTR_EXPORT T *getData(size_t idx) const {
   ...
   * @retval    template T pointer
   */
  template <typename T = float> NNTR_EXPORT T *getScale() const {
   ...
   * @retval    template T pointer
   */
  template <typename T = float> NNTR_EXPORT T *getScale(size_t idx) const {
   ...
   */
  NNTR_EXPORT unsigned int *getZeroPoint() const {
   ...
   * @retval    unsigned int pointer
   */
  NNTR_EXPORT unsigned int *getZeroPoint(size_t idx) const {
   ...
   */
  template <typename T = float> NNTR_EXPORT T *getAddress(unsigned int i) {
   ...
   */
  template <typename T = float>
  NNTR_EXPORT const T *getAddress(unsigned int i) const {
    return (T *)itensor_->getAddress(i);
  }
   ...
   */
  template <typename T = float>
  NNTR_EXPORT T *getAddress(unsigned int b, unsigned int c, unsigned int h,
                            unsigned int w) {
   ...
   */
  template <typename T = float>
  NNTR_EXPORT const T *getAddress(unsigned int b, unsigned int c,
   ...
   */
  template <typename T = float>
  NNTR_EXPORT const T &getValue(unsigned int idx) const noexcept {
   ...
   */
  template <typename T = float>
  NNTR_EXPORT T &getValue(unsigned int idx) noexcept {
    return getData<T>()[idx];
  }
   ...
   */
  template <typename T = float>
  NNTR_EXPORT const T &getValue(unsigned int b, unsigned int c, unsigned int h,
   ...
   */
  template <typename T = float>
  NNTR_EXPORT T &getValue(unsigned int b, unsigned int c, unsigned int h,
   ...
   */
  NNTR_EXPORT void setValue(float value);
   ...
   */
  NNTR_EXPORT void setValueInt(unsigned int offset, int value) noexcept {
   ...
   */
  NNTR_EXPORT void setRandNormal(float mean = 0.0f, float stddev = 0.05f);
   ...
   */
  template <typename T = float> NNTR_EXPORT int apply_i(std::function<T(T)> f) {
    Tensor result = *this;
    apply<T>(f, result);
   ...
   */
  template <typename T = float>
  NNTR_EXPORT Tensor apply(std::function<T(T)> f) const {
    Tensor result;
    apply<T>(f, result);
   ...
   */
  template <typename T = float>
  NNTR_EXPORT Tensor &apply(std::function<T(T)> f, Tensor &output) const {
   ...
   * @retval    Tensor
   */
  NNTR_EXPORT Tensor apply(std::function<Tensor(Tensor)> f) const;
   ...
   * @retval    Tensor
   */
  NNTR_EXPORT Tensor &apply(std::function<Tensor &(Tensor, Tensor &)> f,
                            Tensor &output) const;
   ...
   */
  NNTR_EXPORT int multiply_i_strided(Tensor const &m, const float beta = 0.0);
   ...
   */
  NNTR_EXPORT Tensor multiply_strided(Tensor const &m,
   ...
   * @retval    #ML_ERROR_NONE Successful
   */
  NNTR_EXPORT int multiply_i(float const &value);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor multiply(float const &value) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &multiply(float const &value, Tensor &out) const;
   ...
   * @retval    #ML_ERROR_NONE successful
   */
  NNTR_EXPORT int multiply_i(Tensor const &m, const float beta = 0.0);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor multiply(Tensor const &m, const float beta = 0.0) const;
   ...
   * @retval    #ML_ERROR_NONE Successful
   */
  NNTR_EXPORT int divide_i(float const &value);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor divide(float const &value) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &divide(float const &value, Tensor &output) const;
   ...
   * @retval    #ML_ERROR_NONE successful
   */
  NNTR_EXPORT int divide_i(Tensor const &m);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor divide(Tensor const &m) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &divide(Tensor const &m, Tensor &output) const;
   ...
   */
  NNTR_EXPORT int add_i_strided(Tensor const &input, const float beta = 0.0);
   ...
   */
  NNTR_EXPORT Tensor add_strided(Tensor const &input,
                                 const float beta = 0.0) const;
   ...
   */
  NNTR_EXPORT int add_i(float const &value);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor add(float const &value) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &add(float const &value, Tensor &output) const;
   ...
   * @retval    #ML_ERROR_INVALID_PARAMETER Invalid Parameter
   */
  NNTR_EXPORT int add_i(Tensor const &m, float const alpha = 1.F);
   ...
   * @retval #ML_ERROR_INVALID_PARAMETER Invalid Parameter
   */
  NNTR_EXPORT int add_i_partial(unsigned int len, unsigned int addr_idx,
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor add(Tensor const &m, float const alpha = 1) const;
   ...
   * @retval    #ML_ERROR_INVALID_PARAMETER Invalid Parameter
   */
  NNTR_EXPORT int subtract_i(float const &value);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor subtract(float const &value) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &subtract(float const &value, Tensor &output) const;
   ...
   * @retval    #ML_ERROR_INVALID_PARAMETER Invalid Parameter
   */
  NNTR_EXPORT int subtract_i(Tensor const &m);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor subtract(Tensor const &m) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &subtract(Tensor const &m, Tensor &output) const;

  /**
   * @brief     sum all the Tensor elements according to the batch
   * @retval    Calculated Tensor(batch, 1, 1, 1)
   */
  NNTR_EXPORT Tensor sum_by_batch() const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor sum(unsigned int axis, float alpha = 1.0) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &sum(unsigned int axis, Tensor &output, float alpha = 1.0,
   ...
   * @return Tensor
   */
  NNTR_EXPORT Tensor sum(const std::vector<unsigned int> &axes,
   ...
   * @return Tensor
   */
  NNTR_EXPORT Tensor &sum(const std::vector<unsigned int> &axes, Tensor &output,
                          float alpha = 1.0) const;
   ...
   * @retval Calculated Tensor
   */
  NNTR_EXPORT Tensor &abs(Tensor &output) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor average(unsigned int axis) const;

  /**
   * @brief     Averaging the Tensor elements according to the axis
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &average(unsigned int axis, Tensor &output) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor average(const std::vector<unsigned int> &axes) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &average(const std::vector<unsigned int> &axes,
                              Tensor &output) const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor average() const;

  /**
   * @brief     Averaging the Tensor elements by all axis
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &average(Tensor &output) const;
   ...
   * @retval    #ML_ERROR_NONE  Successful
   */
  NNTR_EXPORT int pow_i(float exponent);
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor pow(float exponent) const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &pow(float exponent, Tensor &output) const;

  /**
   * @brief     Compute square-root element by element
   * @retval    #ML_ERROR_NONE  Successful
   */
  NNTR_EXPORT int sqrt_i();

  /**
   * @brief     Compute square-root by element
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor sqrt() const;
   ...
   * @retval     Calculated Tensor
   */
  NNTR_EXPORT Tensor &sqrt(Tensor &output) const;

  /**
   * @brief     Gauss error function
   * @retval    #ML_ERROR_NONE  Successful
   */
  NNTR_EXPORT int erf_i();

  /**
   * @brief     Gauss error function
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor erf() const;
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor dot(Tensor const &input, bool trans = false,
   ...
   * @retval    Calculated Tensor
   */
  NNTR_EXPORT Tensor &dot(Tensor const &input, Tensor &output,
   ...
   * data in the tensor
   */
  NNTR_EXPORT Tensor &dot_deriv_wrt_1(Tensor const &input,
   ...
   * @note The caller tensor must be the same tensor as the one which called
   the dot() product.
   */
  NNTR_EXPORT Tensor &dot_deriv_wrt_2(Tensor &input_deriv,
                                      Tensor const &output_deriv,
                                      bool trans = false, bool trans_in = false,
                                      float beta = 0.0f) const;
   ...
   * @details performs dot operation over a batch of inputs. If the batch sizes
   ...
   of the smaller one.
   */
  NNTR_EXPORT Tensor &dotBatched(Tensor const &input, Tensor &result,
                                 bool trans = false, bool trans_in = false,
                                 float beta = 0.0f) const;
   ...
   */
  NNTR_EXPORT Tensor &dot_batched_deriv_wrt_1(Tensor const &input,
                                              Tensor const &output_deriv,
                                              bool trans = false,
                                              bool trans_in = false,
                                              float beta = 0.0f);
   ...
   */
  NNTR_EXPORT Tensor &dot_batched_deriv_wrt_2(Tensor &input_deriv,
                                              Tensor const &output_deriv,
                                              bool trans = false,
                                              bool trans_in = false,
                                              float beta = 0.0f) const;
   ...
   */
  NNTR_EXPORT Tensor dropout_mask(float dropout) const;

  /**
   * @brief Calculate Drop Out Mask : x * 1.0/(1.0-rate) inplace
   * @param dropout drop out rate
   */
  NNTR_EXPORT void dropout_mask(float dropout);
   ...
   */
  NNTR_EXPORT void filter_mask(const Tensor &mask_len, bool reverse = false);
   ...
   */
  NNTR_EXPORT Tensor zoneout_mask(float zoneout);
   ...
   * @param zoneout zone out rate
   */
  NNTR_EXPORT void zoneout_mask(Tensor &opposite, float zoneout);
   ...
   */
  NNTR_EXPORT std::vector<Tensor> split(unsigned num_size, int axis = 0);
   ...
   * @return Tensor concatenated tensor
   */
  NNTR_EXPORT static Tensor cat(const std::vector<Tensor> &tensors,
                                int axis = 0);
   ...
   * @return Tensor concatenated tensor
   */
  NNTR_EXPORT static Tensor cat(const std::vector<Tensor> &tensors, int axis,
                                Tensor &output);
   ...
   */
  NNTR_EXPORT void print(std::ostream &out) const;
   ...
   */
  NNTR_EXPORT void setData(const std::shared_ptr<MemoryData> buf,
                           size_t off = 0, bool init = false);
   ...
   */
  NNTR_EXPORT void copy(const Tensor &from);
   ...
   * @note      support copying data from multiple data type
   */
  NNTR_EXPORT void copyData(const Tensor &from);
   ...
   */
  NNTR_EXPORT void copy_with_stride(const Tensor &from);
   ...
   * copy
   */
  NNTR_EXPORT Tensor getBatchSlice(size_t offset, unsigned int size) const;

  /**
   * @brief     Convient wrapper for inplace copy of @a this.
   * @retval    Copied version of this
   */
  NNTR_EXPORT Tensor clone() const;
   ...
   * @retval    Copied version of this
   */
  NNTR_EXPORT Tensor clone(ml::train::TensorDim::DataType type) const;

  /**
   * @brief     Read the Tensor For FSU
   *
   */
  NNTR_EXPORT void readFSU();

  /**
   * @brief     Save the Tensor into file
   * @param[in] file output file stream
   */
  NNTR_EXPORT void save(std::ostream &file);

  /**
   * @brief     Read the Tensor from file
   * @param[in] file input file stream
   */
  NNTR_EXPORT void read(std::ifstream &file, size_t start_offset = 0,
   ...
   */
  NNTR_EXPORT std::vector<unsigned int> argmax() const;

  /**
   * @brief     return argument index which value is min by batch
   * @retval    unsigned int argument indices
   */
  NNTR_EXPORT std::vector<unsigned int> argmin() const;
   ...
   * @return Tensor
   */
  NNTR_EXPORT Tensor transpose(const std::string &direction) const;
   ...
   */
  NNTR_EXPORT void fill(const Tensor &from, bool allocate = false);

  /**
   * @brief     return a copy of the Tensor Dim
   * @retval    TensorDim
   */
  NNTR_EXPORT TensorDim getDim() const;
   ...
   */
  NNTR_EXPORT Initializer getInitializer() const;

  /**
   * @brief Get format for the tensor
   * @return format of the tensor
   */
  NNTR_EXPORT TensorDim::Format getFormat() const;
   ...
   */
  NNTR_EXPORT Tdatatype getDataType() const;
   ...
   */
  NNTR_EXPORT const bool getContiguous() const noexcept;
   ...
   */
  NNTR_EXPORT bool checkContinuous(unsigned int np1, unsigned int np2) const;

  /**
   * @brief     set FileOffset to Tensor
   * @param     off FileOffset
   */
  NNTR_EXPORT void setFileOffset(size_t file_offset);
   ...
   */
  NNTR_EXPORT void setName(const std::string &name_);
   ...
   * tensor.
   */
  NNTR_EXPORT void createSharedDataTensor(const Tensor &src, Tensor &dest,
                                          size_t offset) const;
   ...
   * tensor.
   */
  NNTR_EXPORT Tensor getSharedDataTensor(const TensorDim dim_, size_t offset,
   ...
   */
  NNTR_EXPORT friend void swap(Tensor &lhs, Tensor &rhs) noexcept {
   ...
   */
  NNTR_EXPORT bool isValid() const { return itensor_->isValid(); };
 ...
 */
NNTR_EXPORT std::ostream &operator<<(std::ostream &out, Tensor const &input);
