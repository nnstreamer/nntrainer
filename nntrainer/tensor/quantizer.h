...
protected:
   ...
   */
  NNTR_EXPORT static void registerQuantizer(QScheme qscheme,
                                            Quantizer &quantizer) {
   ...
   * @param qtype quantized data type
   */
  NNTR_EXPORT void calculateMinMaxValue(ml::train::TensorDim::DataType qtype);

public:
  /**
   * @brief Basic Constructor of a Quantizer
   */
  NNTR_EXPORT Quantizer() = default;

  /**
   * @brief Basic Destructor of a Quantizer
   */
  NNTR_EXPORT virtual ~Quantizer() = default;
   ...
   */
  NNTR_EXPORT static Quantizer *getRegisteredQuantizer(QScheme qscheme) {
   ...
   */
  NNTR_EXPORT virtual std::unique_ptr<Quantizer> create() = 0;
   ...
   */
  NNTR_EXPORT virtual Tensor quantize(const Tensor &input,
                                      ml::train::TensorDim::DataType qtype) = 0;
   ...
   * @return Tensor quantized tensor
   */
  NNTR_EXPORT virtual Tensor &quantize(const Tensor &input, Tensor &output,
                                       float *scales,
   ...
   */
  NNTR_EXPORT virtual Tensor
  dequantize(const Tensor &input, ml::train::TensorDim::DataType qtype) = 0;

  /**
   * @brief Get quantization Scheme type.
   * @return Quantization scheme
   */
  NNTR_EXPORT virtual QScheme qscheme() const = 0;
};
...
public:
  NNTR_EXPORT UniformQuantizer() : Quantizer() {}
};
...
public:
  NNTR_EXPORT NonUniformQuantizer() : Quantizer() {}
};
...
public:
   ...
   */
  NNTR_EXPORT PerTensorAffineQuantizer() : UniformQuantizer(), scale(1) {}

  /**
   * @copydoc Quantizer::create()
   */
  NNTR_EXPORT std::unique_ptr<Quantizer> create() override;

  /**
   * @copydoc Quantizer::quantize(const Tensor &input)
   */
  NNTR_EXPORT Tensor quantize(const Tensor &input,
   ...
   */
  NNTR_EXPORT Tensor &quantize(const Tensor &input, Tensor &output,
                               float *scales,
   ...
   */
  NNTR_EXPORT Tensor dequantize(const Tensor &input,
                                ml::train::TensorDim::DataType dtype) override;

  /**
   * @copydoc Quantizer::qscheme()
   */
  NNTR_EXPORT QScheme qscheme() const override;
...
public:
   ...
   */
  NNTR_EXPORT PerChannelAffineQuantizer() : UniformQuantizer() {}
...
public:
   ...
   */
  NNTR_EXPORT BinaryCodeBasedQuantizer() : NonUniformQuantizer() {}
...
public:
   ...
   */
  NNTR_EXPORT static std::unique_ptr<Quantizer>
  createQuantizer(QScheme qscheme) {
    switch (qscheme) {
