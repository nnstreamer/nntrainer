 ...
 */
NNTR_API Tensor dotCl(Tensor const &input, Tensor const &m, bool trans = false,
                      bool trans_m = false);
 ...
 * @param[in] trans_m bool
 */
NNTR_API void dotCl(Tensor const &input, Tensor const &m, Tensor &result,
 ...
 * @param[in] trans_m bool
 */
NNTR_API void dotBatchedCl(Tensor const &input, Tensor const &m, Tensor &result,
                           bool trans = false, bool trans_m = false);
 ...
 * @param[in] RunLayerContext reference
 */
NNTR_API void multiplyCl(Tensor &input, float const &value);
 ...
 * @param[in] input Tensor
 */
NNTR_API void add_i_cl(Tensor &result, Tensor const &input);
 ...
 * @param[in] result Tensor
 */
NNTR_API void transposeCl(const std::string &direction, Tensor const &in,
                          Tensor &result);
 ...
 * @param result Tensor
 */
NNTR_API void copyCl(const Tensor &input, Tensor &result);
 ...
 */
NNTR_API float nrm2Cl(const Tensor &input);
 ...
 */
NNTR_API float asumCl(const Tensor &input);
 ...
 */
NNTR_API int amaxCl(const Tensor &input);
 ...
 */
NNTR_API int aminCl(const Tensor &input);
