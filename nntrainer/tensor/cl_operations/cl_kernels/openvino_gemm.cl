...
#define DECOMPRESSION_SCALE_GROUPS_NUM (SIZE_N / DECOMPRESSION_SCALE_GROUP_SIZE)

#define DECOMPRESSION_SCALE_BATCH_NUM SIZE_K
#define DECOMPRESSION_SCALE_BATCH_PITCH DECOMPRESSION_SCALE_GROUPS_NUM
#define DECOMPRESSION_SCALE_FEATURE_PITCH 1
#define DECOMPRESSION_SCALE_LENGTH (SIZE_K * DECOMPRESSION_SCALE_GROUPS_NUM)
