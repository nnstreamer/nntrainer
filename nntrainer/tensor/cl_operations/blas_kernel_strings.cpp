...
const std::string &getSgemmClKernel_Q6_K_F32() {
  static const std::string sgemm_cl_kernel_Q6_K_F32_ =
    R"(
  ...
  return sgemm_cl_kernel_Q6_K_F32_;
}

const std::string &getSgemmClKernel_Q6_K_Q8_1() {
  // NOTE(m.wlasiuk) :
  // https://github.com/ggml-org/llama.cpp/blob/c46503014db0d63fa7b1b28c58adfb51054e2dec/ggml/src/ggml-cuda/mmq.cuh#L1696
  // NOTE(m.wlasiuk) :
  // https://github.com/ggml-org/llama.cpp/blob/c46503014db0d63fa7b1b28c58adfb51054e2dec/ggml/src/ggml-cuda/vecdotq.cuh#L765
  static const std::string sgemm_cl_kernel_Q6_K_Q8_1 =
    R"(
  
  )";
  return sgemm_cl_kernel_Q6_K_Q8_1;
}

const std::string &getSgemmClKernel_Q4_K_Q8_1() {
  // NOTE(m.wlasiuk) :
  // https://github.com/ggml-org/llama.cpp/blob/c46503014db0d63fa7b1b28c58adfb51054e2dec/ggml/src/ggml-cuda/vecdotq.cuh#L673
  // NOTE(m.wlasiuk) :
  // https://github.com/ggml-org/llama.cpp/blob/c46503014db0d63fa7b1b28c58adfb51054e2dec/ggml/src/ggml-cuda/mmq.cuh#L1440
  static const std::string sgemm_cl_kernel_Q4_K_Q8_1 =
    R"(

  )";
  return sgemm_cl_kernel_Q4_K_Q8_1;
}
