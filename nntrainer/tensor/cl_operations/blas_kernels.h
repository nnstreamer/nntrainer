...
/**
 * @brief     transpose computation about channels and height
...
/**
 * @brief     transpose computation about height and width
 * @param[in] input float * for Input Tensor
 * @param[in] res float * for Output Tensor
 * @param[in] input_batch_size  represents the number of samples in the input
 * tensor
...
/**
 * @brief     transpose computation about channels and width
 * @param[in] input float * for Input Tensor
 * @param[in] res float * for Output Tensor
 * @param[in] input_batch_size  represents the number of samples in the input
 * tensor
