...
public:
   ...
   */
  NNTR_EXPORT explicit CachePool(const std::string &name);

  /**
   * @brief CachePool constructor with cache path
   *
   */
  NNTR_EXPORT explicit CachePool(const std::string &path,
   ...
   *
   */
  NNTR_EXPORT explicit CachePool(
   ...
   */
  NNTR_EXPORT void inActive(unsigned int order);

  /**
   * @brief Do the allocation of cache
   *
   */
  NNTR_EXPORT virtual void allocate() override;

  /**
   * @brief Free all the allocated cache
   *
   */
  NNTR_EXPORT virtual void deallocate() override;
   ...
   */
  NNTR_EXPORT virtual std::shared_ptr<MemoryData>
   ...
   */
  NNTR_EXPORT virtual bool isAllocated() const override;
   ...
   */
  NNTR_EXPORT virtual void flush();
   ...
   */
  NNTR_EXPORT virtual void flushExcept(unsigned int order);
   ...
   * @param order except execution order
   */
  NNTR_EXPORT virtual void flushExcept(std::vector<unsigned int> order);

  /**
   * @brief Clear the memory pool
   *
   */
  NNTR_EXPORT virtual void clear() override;
   ...
   */
  NNTR_EXPORT virtual void loadExec(unsigned int order);
   ...
   */
  NNTR_EXPORT virtual void loadTensor(unsigned int order);
   ...
   * @param order execution order
   */
  NNTR_EXPORT virtual bool loadExecOnce(unsigned int order, ExecIdsIter &iter);
   ...
   * @param order execution order
   */
  NNTR_EXPORT virtual void unloadExec(unsigned int order);
   ...
   */
  NNTR_EXPORT virtual void unloadTensor(unsigned int order);

  /**
   * @brief Load active cache data
   */
  NNTR_EXPORT virtual void loadActives();

  /**
   * @brief Unload active cache data
   */
  NNTR_EXPORT virtual void unloadActives();
   ...
   */
  NNTR_EXPORT virtual std::string getName() { return name; }
   ...
   */
  NNTR_EXPORT ml::train::ExecutionMode getExecMode() const {
   ...
   */
  NNTR_EXPORT void setFsuWeightPath(std::string path) override;
   ...
   */
  NNTR_EXPORT std::set<unsigned int> getExecIDs(unsigned int order) {
   ...
   */
  NNTR_EXPORT std::list<std::shared_ptr<CacheElem>> getActiveElems() {
    return actives;
  }
   ...
   * @return Cache Elem
   */
  NNTR_EXPORT std::shared_ptr<CacheElem> getCacheElem(unsigned int id) {
    return elems[id];
  }
   ...
   */
  NNTR_EXPORT bool isLoaded(unsigned int id) { return elems[id]->isActive(); }
...
protected:
   ...
   */
  NNTR_EXPORT virtual void validate(unsigned int id);
   ...
   * @param cache element id
   */
  NNTR_EXPORT virtual void invalidate(unsigned int id);
   ...
   */
  NNTR_EXPORT std::vector<CachePolicy> &getCachePolicy() { return policies; }
