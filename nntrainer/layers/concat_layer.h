...
public:
   ...
   */
  NNTR_EXPORT ConcatLayer();

  /**
   * @brief     Destructor of Concat Layer
   */
  NNTR_EXPORT ~ConcatLayer() = default;

  /**
   *  @brief  Move constructor of ConcatLayer.
   *  @param[in] ConcatLayer &&
   */
  NNTR_EXPORT ConcatLayer(ConcatLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs ConcatLayer to be moved.
   */
  NNTR_EXPORT ConcatLayer &operator=(ConcatLayer &&rhs) = default;
