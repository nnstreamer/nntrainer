...
public:
   ...
   */
  NNTR_API RNNCellLayer();

  /**
   * @brief     Destructor of RNNCellLayer
   */
  NNTR_API ~RNNCellLayer() = default;

  /**
   *  @brief  Move constructor.
   *  @param[in] RNNCellLayer &&
   */
  NNTR_API RNNCellLayer(RNNCellLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs RNNCellLayer to be moved.
   */
  NNTR_API RNNCellLayer &operator=(RNNCellLayer &&rhs) = default;
