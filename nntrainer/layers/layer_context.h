...
public:
   ...
   */
  NNTR_API TensorDim::Format getFormat() {
   ...
   */
  NNTR_API TensorDim::DataType getWeightDataType() {
   ...
   */
  NNTR_API TensorDim::DataType getActivationDataType() {
    return str_converter<enum_class_prop_tag, nntrainer::TensorDataTypeInfo>::
   ...
   */
  NNTR_API ml::train::LayerComputeEngine getComputeEngineType() {
    return engine;
  };
   ...
   */
  NNTR_API const ml::train::ExecutionMode &getExecutionMode() const {
    return mode;
  }
   ...
   */
  NNTR_API unsigned int getNumInputs() const { return input_dim.size(); }
   ...
   */
  NNTR_API unsigned int getNumRequestedOutputs() const;
   ...
   */
  NNTR_API const std::vector<TensorDim> &getInputDimensions() const {
    return input_dim;
  }
   ...
   */
  NNTR_API const TensorDim::DataType getInputDataType(int idx) const {
   ...
   */
  NNTR_API std::vector<TensorDim> &getMutableInputDimensions() {
    return input_dim;
  }
   ...
   */
  NNTR_API void setInputDataType(TensorDim::DataType ty) {
   ...
   */
  NNTR_API void setOutputDimensions(const std::vector<TensorDim> &out_dim);
   ...
   * start from 0 and will always be incremental.
   */
  NNTR_API unsigned int requestWeight(
   ...
   * start from 0 and will always be incremental.
   */
  NNTR_API unsigned int requestWeight(const WeightSpec &spec) {
   ...
   * start from 0 and will always be incremental.
   */
  NNTR_API unsigned int requestTensor(
   ...
   * start from 0 and will always be incremental.
   */
  NNTR_API unsigned int requestTensor(const TensorSpec &spec) {
   ...
   */
  NNTR_API const std::vector<WeightSpec> &getWeightsSpec() const {
    return weights_spec;
  }
   ...
   */
  NNTR_API unsigned int getNumWeights() const { return weights_spec.size(); }
   ...
   */
  NNTR_API const std::vector<TensorSpec> &getTensorsSpec() const {
    return tensors_spec;
  }
   ...
   */
  NNTR_API unsigned int getNumTensors() const { return tensors_spec.size(); }
   ...
   */
  NNTR_API void requestOutputs(std::vector<VarGradSpecV2> &&out_specs);
   ...
   */
  NNTR_API const std::vector<VarGradSpecV2> &getOutSpecs() const;
   ...
   */
  NNTR_API bool getInPlace() const { return is_inplace; }
   ...
   * @return loss_scale
   */
  NNTR_API float getLossScale() const { return loss_scale; }
   ...
   */
  NNTR_API bool isMixedTraining() { return istrequal(tensor_type[1], "FP32"); }
...
public:
   ...
   *
   */
  NNTR_API RunLayerContext(const std::string &name, bool is_inplace_) :
    RunLayerContext() {
   ...
   */
  NNTR_API RunLayerContext(const std::string &name, bool trainable, float l,
   ...
   */
  NNTR_API void getWeight(Tensor &w, unsigned int idx) {
   ...
   * @return Tensor& Reference to the weight tensor
   */
  NNTR_API Tensor &getWeight(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getWeightGrad(unsigned int idx) const;
   ...
   * @return Tensor& Reference to the weight grad tensor
   */
  NNTR_API Tensor &getWeightFP32(unsigned int idx) const;
   ...
   * @return Tensor& Reference to the weight grad tensor
   */
  NNTR_API Tensor &getWeightOptVar(unsigned int idx, unsigned int jdx) const;
   ...
   */
  NNTR_API const std::string &getWeightName(unsigned int idx) const;
   ...
   */
  NNTR_API bool weightHasGradient(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getOutput(unsigned int idx);
   ...
   * @return Tensor& Reference to the output tensor
   */
  NNTR_API const Tensor &getOutput(unsigned int idx) const;
   ...
   */
  NNTR_API const Tensor getOutputGrad(unsigned int idx) const;
   ...
   * use getOutputGrad().
   */
  NNTR_API Tensor &getOutputGradUnsafe(unsigned int idx);
   ...
   * @return true if weight has gradient, else false
   */
  NNTR_API bool outputHasGradient(unsigned int idx) const;
   ...
   * gradient, return a temporary, initialized to zero
   */
  NNTR_API const Tensor getIncomingDerivative(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getInput(unsigned int idx);
   ...
   * @return Tensor& Reference to the input grad tensor
   */
  NNTR_API const Tensor &getInput(unsigned int idx) const;
   ...
   * @return Tensor& Reference to the input grad tensor
   */
  NNTR_API Tensor &getInputGrad(unsigned int idx);
   ...
   * @return true if weight has gradient, else false
   */
  NNTR_API bool inputHasGradient(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getOutgoingDerivative(unsigned int idx);
   ...
   */
  NNTR_API Tensor &getTensor(unsigned int idx);
   ...
   * @return Tensor& Reference to the tensor
   */
  NNTR_API const Tensor &getTensor(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getTensorGrad(unsigned int idx);
   ...
   * @return Tensor& Reference to the tensor grad tensor
   */
  NNTR_API const Tensor &getTensorGrad(unsigned int idx) const;
   ...
   */
  NNTR_API bool tensorHasGradient(unsigned int idx) const;
   ...
   */
  NNTR_API bool isWeightDependent(unsigned int idx) const;
   ...
   */
  NNTR_API bool isGradientFirstAccess(unsigned int idx) const;
   ...
   */
  NNTR_API bool isGradientLastAccess(unsigned int idx) const;
   ...
   */
  NNTR_API bool isGradientClipByGlobalNorm(unsigned int idx) const;
   ...
   */
  NNTR_API bool isMixedPrecision(unsigned int idx) const;
   ...
   */
  NNTR_API const std::string &getTensorName(unsigned int idx) const;
   ...
   */
  NNTR_API unsigned int getNumOutputs() const;
   ...
   */
  NNTR_API unsigned int getNumInputs() const;
   ...
   */
  NNTR_API unsigned int getNumWeights() const;
   ...
   */
  NNTR_API unsigned int getNumWeightOptVar(unsigned int idx) const;
   ...
   * @return unsigned int number of requested tensors
   */
  NNTR_API unsigned int getNumTensors() const;
  /**
   ...
   */
  NNTR_API void updateTensor(unsigned int idx, unsigned int batch);
   ...
   */
  NNTR_API void updateInput(unsigned int idx, TensorDim dim);
   ...
   * @param dim dimension to be updated
   */
  NNTR_API void updateOutput(unsigned int idx, TensorDim dim);
   ...
   * @param dim dimension to be updated
   */
  NNTR_API void updateTensor(unsigned int idx, TensorDim dim);
   ...
   */
  NNTR_API Weight &getWeightObject(unsigned int idx);
   ...
   */
  NNTR_API bool isLabelAvailable(unsigned int idx) const;
   ...
   */
  NNTR_API Tensor &getLabel(unsigned int idx);
   ...
   */
  NNTR_API void setLoss(float val) { loss = val; }
   ...
   */
  NNTR_API float getLoss() const { return loss; }
   ...
   */
  NNTR_API float getRegularizationLoss() const {
    float loss_ = 0;
  ...
  NNTR_API std::shared_ptr<ContextData> getContextData() { return ct_data; }
   ...
   */
  NNTR_API bool getTrainable() const {
   ...
   */
  NNTR_API bool readyToUse() const;
   ...
   * @return true if ready, else false
   */
  NNTR_API bool validate(bool skip_input = false, bool skip_label = false);
   ...
   * @return weights
   */
  NNTR_API std::vector<Weight *> getWeights() { return weights; }

  /**
   * @brief get loss scale
   * @return loss scale
   */
  NNTR_API float getLossScale() { return loss_scale; }
   ...
   * @return loss_scale
   */
  NNTR_API void setLossScale(float scale) {
    loss_scale = scale;
    for (auto w : weights) {
   ...
   *
   */
  NNTR_API void reStoreData(bool nb) { restoreData = nb; }

  /**
   * @brief   get Output Zero Flag.
   *
   */
  NNTR_API bool reStoreData() { return restoreData; }
...
private:
   ...
   */
  NNTR_API float getWeightRegularizationLoss(unsigned int idx) const;
};
