...
public:
   ...
   *  @param[in] AddLayer &&
   */
  NNTR_API AddLayer(AddLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs AddLayer to be moved.
   */
  NNTR_API AddLayer &operator=(AddLayer &&rhs) = default;
   ...
   */
  NNTR_API bool supportBackwarding() const final { return true; };
   ...
   */
  NNTR_API const std::string getType() const final { return AddLayer::type; }
