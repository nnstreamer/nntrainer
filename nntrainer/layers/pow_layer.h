...
public:
   ...
   *  @param[in] PowLayer &&
   */
  NNTR_API PowLayer(PowLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs PowLayer to be moved.
   */
  NNTR_API PowLayer &operator=(PowLayer &&rhs) = default;
   ...
   */
  NNTR_API const std::string getType() const final { return PowLayer::type; };
