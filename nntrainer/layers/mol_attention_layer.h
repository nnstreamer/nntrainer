...
public:
   ...
   */
  NNTR_EXPORT MoLAttentionLayer(MoLAttentionLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs MoLAttentionLayer to be moved.
   */
  NNTR_EXPORT MoLAttentionLayer &operator=(MoLAttentionLayer &&rhs) = default;
...
private:
   ...
   */
  NNTR_EXPORT void calcDerivativeHelper(RunLayerContext &context, Tensor &dstate);
};
