...
public:
  ...
  NNTR_EXPORT ActiFunc(ActivationType at = ActivationType::ACT_NONE,
   ...
   */
  template <typename T = float>
  NNTR_EXPORT void setActiFunc(ActivationType acti_type) {
   ...
   */
  NNTR_EXPORT void run_fn(Tensor const &input, Tensor &output) {
   ...
   * @retVal    Tensor
   */
  NNTR_EXPORT Tensor &run_prime_fn(Tensor &input, Tensor &output,
   ...
   * @retVal    Tensor
   */
  NNTR_EXPORT Tensor &run_prime_fn(Tensor &output, Tensor &outgoing_derivative,
                                   Tensor const &incoming_derivative) {
   ...
   */
  NNTR_EXPORT bool supportInPlace() const { return is_inplace; }
   ...
   */
  NNTR_EXPORT void setInPlace(bool val) {
