...
public:
   ...
   */
  NNTR_API GRUCellLayer();

  /**
   * @brief     Destructor of GRUCellLayer
   */
  NNTR_API ~GRUCellLayer() = default;

  /**
   *  @brief  Move constructor.
   *  @param[in] GRUCellLayer &&
   */
  NNTR_API GRUCellLayer(GRUCellLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs GRUCellLayer to be moved.
   */
  NNTR_API GRUCellLayer &operator=(GRUCellLayer &&rhs) = default;
