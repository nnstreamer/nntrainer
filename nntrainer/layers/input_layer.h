...
public:
   ...
   */
  NNTR_EXPORT InputLayer();

  /**
   * @brief     Destructor of InputLayer
   */
  NNTR_EXPORT ~InputLayer() = default;

  /**
   *  @brief  Move constructor of Pooling 2D Layer.
   *  @param[in] Input &&
   */
  NNTR_EXPORT InputLayer(InputLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs InputLayer to be moved.
   */
  NNTR_EXPORT InputLayer &operator=(InputLayer &&rhs) = default;
