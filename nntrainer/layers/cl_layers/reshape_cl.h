...
public:
  ...
  static opencl::Kernel kernel_reshape;
  static opencl::Kernel kernel_reshape_fp16;
   ...
   * @param[in] context RunLayerContext reference
   */
  void reshape_cl(const float *input, float *res, unsigned int input_batch_size,
   ...
   * @param[in] context RunLayerContext reference
   */
  void reshape_cl_fp16(const __fp16 *input, __fp16 *res,
