...
public:
   ...
   */
  NNTR_EXPORT ConcatLayerCl();

  /**
   * @brief     Destructor of Concat Layer
   */
  NNTR_EXPORT ~ConcatLayerCl() = default;

  /**
   *  @brief  Move constructor of ConcatLayer.
   *  @param[in] ConcatLayer &&
   */
  NNTR_EXPORT ConcatLayerCl(ConcatLayerCl &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs ConcatLayer to be moved.
   */
  NNTR_EXPORT ConcatLayerCl &operator=(ConcatLayerCl &&rhs) = default;
   ...
   */
  NNTR_EXPORT void ConcatProcess(Tensor const &input1, Tensor const &input2,
                              Tensor &result);
   ...
   */
  NNTR_EXPORT void concat_cl_axis3(const float *matAdata, const float *vecXdata,
   ...
   */
  NNTR_EXPORT void concat_cl_axis2(const float *matAdata, const float *vecXdata,
                                float *vecYdata, unsigned int input1_batch_size,
                                unsigned int input1_channels,
                                unsigned int input1_width,
                                unsigned int input1_height,
   ...
   */
  NNTR_EXPORT void concat_cl_axis1(const float *matAdata, const float *vecXdata,
                                float *vecYdata, unsigned int input1_batch_size,
                                unsigned int input1_height,
                                unsigned int input1_width,
                                unsigned int input1_channels,
   ...
   * @param[in] input2_channels   represents the channels of the input tensor X
   */
  NNTR_EXPORT void concat_cl_axis1_fp16(const _FP16 *matAdata,
