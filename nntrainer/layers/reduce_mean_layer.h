...
public:
   ...
   */
  NNTR_API ReduceMeanLayer() : Layer() {}

  /**
   * @brief     Destructor of Reduce Mean Layer
   */
  NNTR_API ~ReduceMeanLayer(){};

  /**
   *  @brief  Move constructor of ReduceMeanLayer.
   *  @param[in] ReduceMeanLayer &&
   */
  NNTR_API ReduceMeanLayer(ReduceMeanLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs ReduceMeanLayer to be moved.
   */
  NNTR_API ReduceMeanLayer &operator=(ReduceMeanLayer &&rhs) = default;
