...
public:
   ...
   */
  NNTR_API BatchNormalizationLayer();
   ...
   */
  NNTR_API void save(std::ofstream &file, RunLayerContext &run_context,
   ...
   */
  NNTR_API void read(std::ifstream &file, RunLayerContext &context,
                     bool opt_var, ml::train::ExecutionMode mode,
