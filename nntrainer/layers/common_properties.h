...
public:
   ...
   */
  NNTR_EXPORT Name(const std::string &value);
   ...
   */
  NNTR_EXPORT void set(const std::string &value) override;
   ...
   */
  NNTR_EXPORT bool isValid(const std::string &v) const override;
};
...
public:
   ...
   *
   */
  NNTR_EXPORT Trainable(bool val = true) : nntrainer::Property<bool>(val) {}
...
public:
   ...
   */
  NNTR_EXPORT Packed(bool val = true) : nntrainer::Property<bool>(val) {}
...
public:
   ...
   *
   */
  NNTR_EXPORT DisableBias(bool val = false) : nntrainer::Property<bool>(val) {}
  using prop_tag = bool_prop_tag;
...
public:
   ...
   *
   */
  NNTR_EXPORT IntegrateBias(bool val = false) : nntrainer::Property<bool>(val) {}
  using prop_tag = bool_prop_tag;
...
public:
   ...
   *
   */
  NNTR_EXPORT Normalization(bool value = false);
...
public:
   ...
   *
   */
  NNTR_EXPORT Standardization(bool value = false);
...
public:
   ...
   */
  NNTR_EXPORT InputConnection(const Connection &value);
  static constexpr const char *key =
...
public:
   ...
   *
   */
  NNTR_EXPORT Epsilon(float value = 0.001);
...
public:
   ...
   *
   */
  NNTR_EXPORT Exponent(float value = 1.0f);
...
public:
   ...
   *
   */
  NNTR_EXPORT Momentum(float value = 0.99);
...
public:
   ...
   * ml::train::TensorDim::MAXDIM
   */
  NNTR_EXPORT bool isValid(const unsigned int &value) const override;
};
...
public:
  NNTR_EXPORT StartDimension(unsigned int value = 1);
...
public:
  NNTR_EXPORT EndDimension(unsigned int value = ml::train::TensorDim::MAXDIM - 1);
...
public:
   ...
   *
   */
  NNTR_EXPORT PoolSize() {}

  /**
   * @brief Construct a new PoolSize object with default value
   *
   */
  NNTR_EXPORT PoolSize(unsigned int value);
...
public:
   ...
   *
   */
  NNTR_EXPORT Stride(unsigned int value = 1);
...
public:
   ...
   *
   */
  NNTR_EXPORT Dilation(unsigned int value = 1);
...
public:
   ...
   *
   */
  NNTR_EXPORT Padding2D(const std::string &value = "valid") :
   ...
   */
  NNTR_EXPORT std::array<unsigned int, 4>
...
public:
   ...
   *
   */
  NNTR_EXPORT Padding1D(const std::string &value = "valid") :
    nntrainer::Property<std::string>(value) {} /**< default value if any */
  NNTR_EXPORT bool isValid(const std::string &v) const override;
  static constexpr const char *key = "padding"; /**< unique key to access */
  using prop_tag = str_prop_tag;                /**< property type */
   ...
   * @return std::array<unsigned int, 4> list of unsigned padding
   */
  NNTR_EXPORT std::array<unsigned int, 2> compute(const TensorDim &input,
...
public:
   ...
   *
   */
  NNTR_EXPORT DropOutRate(float value = 0.0) : nntrainer::Property<float>(value) {}
  static constexpr const char *key =
   ...
   * @retval false if it is smaller than 0.0
   */
  NNTR_EXPORT bool isValid(const float &v) const override;
};
...
public:
   ...
   * @param value value to set
   */
  NNTR_EXPORT void set(const float &value) override;
};
...
public:
   ...
   */
  NNTR_EXPORT FilePath() : Property<std::string>() {}
   ...
   */
  NNTR_EXPORT FilePath(const std::string &path) { set(path); }
   ...
   */
  NNTR_EXPORT void set(const std::string &v) override;
   ...
   */
  NNTR_EXPORT std::ifstream::pos_type file_size();
...
public:
   ...
   */
  NNTR_EXPORT DirPath() : Property<std::string>() {}
   ...
   * @param path path to set
   */
  NNTR_EXPORT DirPath(const std::string &path) { set(path); }
...
public:
   ...
   *
   */
  NNTR_EXPORT ReturnSequences(bool value = false);
...
public:
   ...
   *
   */
  NNTR_EXPORT Bidirectional(bool value = false);
...
public:
   ...
   *
   */
  NNTR_EXPORT ResetAfter(bool value = true) : nntrainer::Property<bool>(value) {}
...
public:
   ...
   */
  NNTR_EXPORT bool isValid(const unsigned int &v) const override;
};
...
public:
   ...
   *
   */
  NNTR_EXPORT BasicRegularizerConstant(float value = 1.0f);
  static constexpr const char *key =
...
public:
   ...
   *
   */
  NNTR_EXPORT WeightRegularizerConstant(float value = 1.0f);
  static constexpr const char *key =
...
public:
   ...
   *
   */
  NNTR_EXPORT WeightDecay(float value = 0.0f);
  static constexpr const char *key =
...
public:
   ...
   *
   */
  NNTR_EXPORT BiasDecay(float value = 0.0f);
...
public:
   ...
   */
  NNTR_EXPORT OutputLayer(const std::string &name);
...
public:
   ...
   */
  NNTR_EXPORT LabelLayer(const std::string &name);
...
public:
   ...
   *
   */
  NNTR_EXPORT HiddenStateActivation(
...
public:
   ...
   *
   */
  NNTR_EXPORT RecurrentActivation(
    ActivationTypeInfo::Enum value = ActivationTypeInfo::Enum::ACT_NONE);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT WeightInitializer(Initializer value = Initializer::XAVIER_UNIFORM);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT BiasInitializer(Initializer value = Initializer::ZEROS);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT MuInitializer(Initializer value = Initializer::ZEROS);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT VarInitializer(Initializer value = Initializer::ONES);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT GammaInitializer(Initializer value = Initializer::ONES);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT BetaInitializer(Initializer value = Initializer::ZEROS);
  using prop_tag = enum_class_prop_tag;
...
public:
   ...
   */
  NNTR_EXPORT BasicRegularizer(nntrainer::WeightRegularizer value);
  using prop_tag = enum_class_prop_tag;
...
public:
  NNTR_EXPORT FlipDirection(FlipDirectionInfo::Enum value =
...
public:
   ...
   * @param value value to set
   */
  NNTR_EXPORT void set(const TensorDim &value) override;
};
...
public:
   ...
   *
   */
  NNTR_EXPORT ScaledDotProduct(bool value = false);
...
public:
   ...
   *
   */
  NNTR_EXPORT CausalMask(bool value = false);
...
public:
   ...
   *
   */
  NNTR_EXPORT Print(bool value = false) { set(value); }
...
public:
   ...
   *
   */
  NNTR_EXPORT NumHeads(unsigned int value = 1);
...
public:
   ...
   *
   */
  NNTR_EXPORT ReturnAttentionWeight(ReturnAttentionWeightInfo::Enum value =
...
public:
  NNTR_EXPORT PropsUserData(void *user_data);
