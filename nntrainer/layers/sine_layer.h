...
public:
   ...
   *  @param[in] SineLayer &&
   */
  NNTR_EXPORT SineLayer(SineLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs SineLayer to be moved.
   */
  NNTR_EXPORT SineLayer &operator=(SineLayer &&rhs) = default;
   ...
   */
  NNTR_EXPORT const std::string getType() const final { return SineLayer::type; };
