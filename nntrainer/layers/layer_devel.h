...
public:
   ...
   */
  NNTR_API virtual ~Layer() = default;
   ...
   */
  NNTR_API virtual void finalize(InitLayerContext &context) = 0;

  /**
   * @brief    Initialize the layer
   */
  NNTR_API virtual void initialize(RunLayerContext &context){};
   ...
   */
  NNTR_API virtual void forwarding(RunLayerContext &context, bool training) = 0;
   ...
   * can be access from the inputs/outputs tensors themselves.
   */
  NNTR_API virtual void incremental_forwarding(RunLayerContext &context,
                                               unsigned int from,
   ...
   * can be access from the inputs/outputs tensors themselves.
   */
  NNTR_API virtual void calcDerivative(RunLayerContext &context) = 0;
   ...
   */
  NNTR_API virtual void calcGradient(RunLayerContext &context) {}
   ...
   */
  NNTR_API virtual void setProperty(const std::vector<std::string> &values) = 0;
   ...
   */
  NNTR_API virtual std::string getProperty(const std::string &key) {
    return "";
  }
   ...
   */
  NNTR_API virtual void setBatch(RunLayerContext &context, unsigned int batch) {
  }
   ...
   */
  NNTR_API virtual bool supportInPlace() const { return is_inplace; }
   ...
   */
  NNTR_API virtual InPlaceDirection getInPlaceDirection() {
   ...
   * @return InPlaceType
   */
  NNTR_API virtual InPlaceType initializeInPlace() {
    if (!supportInPlace())
   ...
   */
  NNTR_API virtual bool requireLabel() const { return false; }
   ...
   */
  NNTR_API virtual bool supportBackwarding() const = 0;
   ...
   */
  NNTR_API virtual void save(std::ofstream &file, RunLayerContext &run_context,
   ...
   *
   */
  NNTR_API virtual void read(std::ifstream &file, RunLayerContext &run_context,
                             bool opt_var, ml::train::ExecutionMode mode,
                             bool trainable,
