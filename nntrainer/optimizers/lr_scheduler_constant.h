...
public:
   ...
   *
   */
  NNTR_EXPORT ConstantLearningRateScheduler();

  /**
   * @copydoc LearningRateScheduler::getLearningRate(size_t iteration) const
   *
   */
  NNTR_EXPORT virtual double getLearningRate(size_t iteration) override;

  /**
   * @copydoc LearningRateScheduler::finalize()
   *
   */
  NNTR_EXPORT virtual void finalize() override;
