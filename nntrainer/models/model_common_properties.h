...
public:
   ...
   */
  NNTR_API Epochs(unsigned int value = 1);
};
...
public:
   ...
   */
  NNTR_API bool isValid(const std::string &value) const override;
};
...
public:
   ...
   */
  NNTR_API TrainingBatchSize(unsigned int value = 1);
};
...
public:
   ...
   */
  NNTR_API ContinueTrain(bool value = false);
};
...
public:
   ...
   */
  NNTR_API MemoryOptimization(bool value = true);
};
...
public:
   ...
   */
  NNTR_API FsuPath(const std::string &value = ".");
};
...
public:
   ...
   * @param value value to set, defaults to current directory
   */
  NNTR_API FsuLookahead(const unsigned int &value = 0);
};
...
public:
   ...
   */
  NNTR_API ModelTensorDataType(ModelTensorDataTypeInfo::Enum value =
...
public:
  NNTR_API LossScale(float value = 1.0f);
