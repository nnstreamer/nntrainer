...
#define LoadFunction(function) \
  function = reinterpret_cast<PFN_##function>(GetProcAddress((HMODULE)libopencl, #function));
#else
#define LoadFunction(function) \
...
#ifdef _WIN32
    libopencl = LoadLibraryA(kClLibName);
#else
...
#ifdef _WIN32
    ml_loge("Can not open OpenCL library on this device");
#else
  // record error
