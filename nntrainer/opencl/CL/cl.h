...
extern CL_API_ENTRY cl_int CL_API_CALL clGetPlatformInfo(
...
extern CL_API_ENTRY cl_int CL_API_CALL clSetDefaultDeviceCommandQueue(
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetHostTimer(
...
extern CL_API_ENTRY cl_context CL_API_CALL clCreateContextFromType(
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetContextInfo(
...
extern CL_API_ENTRY cl_mem CL_API_CALL clCreateSubBuffer(
...
extern CL_API_ENTRY cl_mem CL_API_CALL clCreateImage(
...
extern CL_API_ENTRY cl_int CL_API_CALL clRetainMemObject(cl_mem memobj)
  CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clReleaseMemObject(cl_mem memobj)
  CL_API_SUFFIX__VERSION_1_0;
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetMemObjectInfo(
  cl_mem memobj, cl_mem_info param_name, size_t param_value_size,
  void *param_value, size_t *param_value_size_ret) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clGetImageInfo(
...
extern CL_API_ENTRY cl_sampler CL_API_CALL clCreateSamplerWithProperties(
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetSamplerInfo(
  cl_sampler sampler, cl_sampler_info param_name, size_t param_value_size,
  void *param_value, size_t *param_value_size_ret) CL_API_SUFFIX__VERSION_1_0;

/* Program Object APIs */
extern CL_API_ENTRY cl_program CL_API_CALL clCreateProgramWithSource(
  cl_context context, cl_uint count, const char **strings,
  const size_t *lengths, cl_int *errcode_ret) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_program CL_API_CALL clCreateProgramWithBinary(
...
extern CL_API_ENTRY cl_program CL_API_CALL clLinkProgram(
  cl_context context, cl_uint num_devices, const cl_device_id *device_list,
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetProgramInfo(
  cl_program program, cl_program_info param_name, size_t param_value_size,
  void *param_value, size_t *param_value_size_ret) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clGetProgramBuildInfo(
...
extern CL_API_ENTRY cl_int CL_API_CALL clCreateKernelsInProgram(
  cl_program program, cl_uint num_kernels, cl_kernel *kernels,
  cl_uint *num_kernels_ret) CL_API_SUFFIX__VERSION_1_0;

#ifdef CL_VERSION_2_1

extern CL_API_ENTRY cl_kernel CL_API_CALL clCloneKernel(
  cl_kernel source_kernel, cl_int *errcode_ret) CL_API_SUFFIX__VERSION_2_1;

#endif

extern CL_API_ENTRY cl_int CL_API_CALL clRetainKernel(cl_kernel kernel)
  CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clReleaseKernel(cl_kernel kernel)
  CL_API_SUFFIX__VERSION_1_0;
...
extern CL_API_ENTRY cl_int CL_API_CALL clSetKernelExecInfo(
  cl_kernel kernel, cl_kernel_exec_info param_name, size_t param_value_size,
  const void *param_value) CL_API_SUFFIX__VERSION_2_0;

#endif

extern CL_API_ENTRY cl_int CL_API_CALL clGetKernelInfo(
...
extern CL_API_ENTRY cl_int CL_API_CALL clGetKernelSubGroupInfo(
...
/* Event Object APIs */
extern CL_API_ENTRY cl_int CL_API_CALL clWaitForEvents(
...
extern CL_API_ENTRY cl_event CL_API_CALL clCreateUserEvent(
  cl_context context, cl_int *errcode_ret) CL_API_SUFFIX__VERSION_1_1;

#endif

extern CL_API_ENTRY cl_int CL_API_CALL clRetainEvent(cl_event event)
  CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clReleaseEvent(cl_event event)
  CL_API_SUFFIX__VERSION_1_0;

#ifdef CL_VERSION_1_1

extern CL_API_ENTRY cl_int CL_API_CALL clSetUserEventStatus(
...
/* Profiling APIs */
extern CL_API_ENTRY cl_int CL_API_CALL clGetEventProfilingInfo(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueReadBuffer(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteBuffer(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueReadImage(
  cl_command_queue command_queue, cl_mem image, cl_bool blocking_read,
  const size_t *origin, const size_t *region, size_t row_pitch,
  size_t slice_pitch, void *ptr, cl_uint num_events_in_wait_list,
  const cl_event *event_wait_list, cl_event *event) CL_API_SUFFIX__VERSION_1_0;

extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueWriteImage(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueFillImage(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueUnmapMemObject(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueNDRangeKernel(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMFree(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMemcpy(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMemFill(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMMap(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueSVMUnmap(
...
extern CL_API_ENTRY
  CL_API_PREFIX__VERSION_1_2_DEPRECATED cl_command_queue CL_API_CALL
