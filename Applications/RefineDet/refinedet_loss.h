...
private:
  ...
  std::vector<std::vector<std::vector<float>>> anchor_gt_label_hw;
  std::vector<std::vector<unsigned int>> gt_class_labels;
  std::vector<unsigned int> num_positive_anchors;
};
