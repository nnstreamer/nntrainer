 ...
 */
WIN_EXPORT class Qwen3CachedSlimMoECausalLM : public Qwen3CausalLM {

public:
  static constexpr const char *architectures = "Qwen3CachedSlimMoeForCausalLM";

  WIN_EXPORT Qwen3CachedSlimMoECausalLM(json &cfg, json &generation_cfg, json &nntr_cfg) :
    Qwen3CausalLM(cfg, generation_cfg, nntr_cfg) {
    setupParameters(cfg, generation_cfg, nntr_cfg);
  }

  WIN_EXPORT virtual ~Qwen3CachedSlimMoECausalLM() = default;
