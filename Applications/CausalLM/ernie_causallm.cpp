...
std::vector<LayerHandle>
Ernie4_5_MoeForCausalLM::createAttention(const int layer_id, int seq_len, int n_heads,
...
void Ernie4_5_MoeForCausalLM::setupParameters(json &cfg, json &generation_cfg,
  ...
  try {
    ...
    MOE_NORM_MIN = cfg.contains("moe_norm_min") ? cfg["moe_norm_min"].get<float>() : 1e-12f;
