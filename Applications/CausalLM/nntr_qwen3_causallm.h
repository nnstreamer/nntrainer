...
#define __NNTR_QWEN_CAUSAL_LM_H__
 ...
 */
WIN_EXPORT class NNTRQwen3CausalLM : public CausalLM {

public:
  static constexpr const char *architectures = "NNTRQwen3ForCausalLM";

  WIN_EXPORT NNTRQwen3CausalLM(json &cfg, json &generation_cfg, json &nntr_cfg) :
    CausalLM(cfg, generation_cfg, nntr_cfg) {}

  WIN_EXPORT virtual ~NNTRQwen3CausalLM() = default;
