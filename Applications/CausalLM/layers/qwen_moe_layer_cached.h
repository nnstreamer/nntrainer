...
#ifndef __CACHED_SLIM_MOE_LAYER_H__
#define __CACHED_SLIM_MOE_LAYER_H__
#ifdef __cplusplus
 ...
 */
WIN_EXPORT class CachedSlimMoELayer : public nntrainer::LayerImpl {
public:
  /**
   * @brief     Constructor of Mixture of Expert Layer
   */
  WIN_EXPORT CachedSlimMoELayer();

  /**
   * @brief     Destructor of Mixture of Expert Layer
   */
  WIN_EXPORT ~CachedSlimMoELayer() = default;

  /**
   * @brief  Move constructor.
   *  @param[in] CachedSlimMoELayer &&
   */
  WIN_EXPORT CachedSlimMoELayer(CachedSlimMoELayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @param[in] rhs CachedSlimMoELayer to be moved.
   */
  WIN_EXPORT CachedSlimMoELayer &operator=(CachedSlimMoELayer &&rhs) = default;
