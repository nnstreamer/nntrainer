...
// V 0.1.0
/**
 * @brief make a hash for a pair of string
 *
 * @tparam T
 * @param seed
 * @param v
...
std::unordered_map<char, std::string> bytes_to_unicode() {
  static std::unordered_map<char, std::string> code_map = {
    ...
    {254, "þ"}, {255, "ÿ"}, {0, "Ā"},   {1, "ā"},   {2, "Ă"},   {3, "ă"},
    {4, "Ą"},   {5, "ą"},   {6, "Ć"},   {7, "ć"},   {8, "Ĉ"},   {9, "ĉ"},
    {10, "Ċ"},  {11, "ċ"},  {12, "Č"},  {13, "č"},  {14, "Ď"},  {15, "ď"},
    {16, "Đ"},  {17, "đ"},  {18, "Ē"},  {19, "ē"},  {20, "Ĕ"},  {21, "ĕ"},
    {22, "Ė"},  {23, "ė"},  {24, "Ę"},  {25, "ę"},  {26, "Ě"},  {27, "ě"},
    {28, "Ĝ"},  {29, "ĝ"},  {30, "Ğ"},  {31, "ğ"},  {32, "Ġ"},  {127, "ġ"},
    {128, "Ģ"}, {129, "ģ"}, {130, "Ĥ"}, {131, "ĥ"}, {132, "Ħ"}, {133, "ħ"},
    {134, "Ĩ"}, {135, "ĩ"}, {136, "Ī"}, {137, "ī"}, {138, "Ĭ"}, {139, "ĭ"},
    {140, "Į"}, {141, "į"}, {142, "İ"}, {143, "ı"}, {144, "Ĳ"}, {145, "ĳ"},
    {146, "Ĵ"}, {147, "ĵ"}, {148, "Ķ"}, {149, "ķ"}, {150, "ĸ"}, {151, "Ĺ"},
    {152, "ĺ"}, {153, "Ļ"}, {154, "ļ"}, {155, "Ľ"}, {156, "ľ"}, {157, "Ŀ"},
    {158, "ŀ"}, {159, "Ł"}, {160, "ł"}, {173, "Ń"}};
  return code_map;
}

/**
 * @brief Unicode to bytes map
 *
...
std::unordered_map<std::string, char> unicode_to_bytes() {
  static std::unordered_map<std::string, char> code_map = {
    ...
    {"{", 123}, {"|", 124}, {"}", 125}, {"~", 126}, {"¡", 161}, {"¢", 162},
    {"£", 163}, {"¤", 164}, {"¥", 165}, {"¦", 166}, {"§", 167}, {"¨", 168},
    {"©", 169}, {"ª", 170}, {"«", 171}, {"¬", 172}, {"®", 174}, {"¯", 175},
    {"°", 176}, {"±", 177}, {"²", 178}, {"³", 179}, {"´", 180}, {"µ", 181},
    {"¶", 182}, {"·", 183}, {"¸", 184}, {"¹", 185}, {"º", 186}, {"»", 187},
    {"¼", 188}, {"½", 189}, {"¾", 190}, {"¿", 191}, {"À", 192}, {"Á", 193},
    {"Â", 194}, {"Ã", 195}, {"Ä", 196}, {"Å", 197}, {"Æ", 198}, {"Ç", 199},
    {"È", 200}, {"É", 201}, {"Ê", 202}, {"Ë", 203}, {"Ì", 204}, {"Í", 205},
    {"Î", 206}, {"Ï", 207}, {"Ð", 208}, {"Ñ", 209}, {"Ò", 210}, {"Ó", 211},
    {"Ô", 212}, {"Õ", 213}, {"Ö", 214}, {"×", 215}, {"Ø", 216}, {"Ù", 217},
    {"Ú", 218}, {"Û", 219}, {"Ü", 220}, {"Ý", 221}, {"Þ", 222}, {"ß", 223},
    {"à", 224}, {"á", 225}, {"â", 226}, {"ã", 227}, {"ä", 228}, {"å", 229},
    {"æ", 230}, {"ç", 231}, {"è", 232}, {"é", 233}, {"ê", 234}, {"ë", 235},
    {"ì", 236}, {"í", 237}, {"î", 238}, {"ï", 239}, {"ð", 240}, {"ñ", 241},
    {"ò", 242}, {"ó", 243}, {"ô", 244}, {"õ", 245}, {"ö", 246}, {"÷", 247},
    {"ø", 248}, {"ù", 249}, {"ú", 250}, {"û", 251}, {"ü", 252}, {"ý", 253},
    {"þ", 254}, {"ÿ", 255}, {"Ā", 0},   {"ā", 1},   {"Ă", 2},   {"ă", 3},
    {"Ą", 4},   {"ą", 5},   {"Ć", 6},   {"ć", 7},   {"Ĉ", 8},   {"ĉ", 9},
    {"Ċ", 10},  {"ċ", 11},  {"Č", 12},  {"č", 13},  {"Ď", 14},  {"ď", 15},
    {"Đ", 16},  {"đ", 17},  {"Ē", 18},  {"ē", 19},  {"Ĕ", 20},  {"ĕ", 21},
    {"Ė", 22},  {"ė", 23},  {"Ę", 24},  {"ę", 25},  {"Ě", 26},  {"ě", 27},
    {"Ĝ", 28},  {"ĝ", 29},  {"Ğ", 30},  {"ğ", 31},  {"Ġ", 32},  {"ġ", 127},
    {"Ģ", 128}, {"ģ", 129}, {"Ĥ", 130}, {"ĥ", 131}, {"Ħ", 132}, {"ħ", 133},
    {"Ĩ", 134}, {"ĩ", 135}, {"Ī", 136}, {"ī", 137}, {"Ĭ", 138}, {"ĭ", 139},
    {"Į", 140}, {"į", 141}, {"İ", 142}, {"ı", 143}, {"Ĳ", 144}, {"ĳ", 145},
    {"Ĵ", 146}, {"ĵ", 147}, {"Ķ", 148}, {"ķ", 149}, {"ĸ", 150}, {"Ĺ", 151},
    {"ĺ", 152}, {"Ļ", 153}, {"ļ", 154}, {"Ľ", 155}, {"ľ", 156}, {"Ŀ", 157},
    {"ŀ", 158}, {"Ł", 159}, {"ł", 160}, {"Ń", 173}};
  return code_map;
}

/**
 * @brief GPT2Encoder is a class that encodes text to ids and decodes ids to
 * text for GPT2 model. this code is based on GPT2 Encoder from OpenAI and using
 * https://github.com/gf712/gpt2-cpp/ code
 */
class GPT2Encoder {

  /**
   * @brief Make Hash Pair for using pair<string, string>
   */
  struct PairHash {
    std::size_t
...
std::optional<GPT2Encoder> GPT2Encoder::load(std::string_view vocab_file,
  ...
  for (struct {
       ...
       std::getline(merges_file_stream, it.line); ++it.i) {
...
std::vector<int64_t> GPT2Encoder::encode(const std::string &text) {
  ...
  for (unsigned int i = 0; i < token_ids.size(); i++) {
    ...
    if (token_ids[i] == 27 && token_ids[i + 1] == 172 &&
        token_ids[i + 2] == 236 && token_ids[i + 3] == 261) {
      processed_result.push_back(26522);
      i = i + 3;
    } else if (token_ids[i] == 172 && token_ids[i + 1] == 236 &&
               token_ids[i + 2] == 261 && token_ids[i + 3] == 27) {
      processed_result.push_back(15600);
      i = i + 3;
    } else if (token_ids[i] == 172 && token_ids[i + 1] == 236 &&
               token_ids[i + 2] == 261) {
      processed_result.push_back(554);
      i = i + 2;
    } else if (token_ids[i] == 396 && token_ids[i + 1] == 261 &&
               token_ids[i + 2] == 27) {
      processed_result.push_back(15600);
      i = i + 2;
      ...
      i = i + 1;
    } else if (token_ids[i] == 751 && token_ids[i + 1] == 260) {
      processed_result.push_back(2046);
      i = i + 1;
    } else if (token_ids[i] == 751 && token_ids[i + 1] == 261) {
      processed_result.push_back(24665);
      i = i + 1;
      ...
      i = i + 1;
    } else if (token_ids[i] == 751 && token_ids[i + 1] == 255) {
      processed_result.push_back(1573);
      i = i + 1;
      ...
      i = i + 2;
    } else if (token_ids[i] == 1821 && token_ids[i + 1] == 236 &&
               token_ids[i + 2] == 260) {
      processed_result.push_back(2046);
      i = i + 2;
    } else if (token_ids[i] == 27 && token_ids[i + 1] == 1821 &&
               token_ids[i + 2] == 236 && token_ids[i + 3] == 261) {
      processed_result.push_back(26522);
      i = i + 3;
    } else if (token_ids[i] == 1821 && token_ids[i + 1] == 236 &&
      ...
      processed_result.push_back(1573);
      i = i + 2;
    } else if (token_ids[i] == 27 && token_ids[i + 1] == 396 &&
               token_ids[i + 2] == 261) {
      processed_result.push_back(26522);
      i = i + 2;
    } else {
...

  {
    ...
    while (true) {
      ...
      ranks.push_back(m_bpe_ranks.find(
        {token.substr(i, length), token.substr(i + length, next_length)}));
