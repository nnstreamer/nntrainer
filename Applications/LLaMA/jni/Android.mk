...
LOCAL_ARM_NEON := true
LOCAL_CFLAGS += -std=c++20 -Ofast -mcpu=cortex-a53 -Ilz4-nougat/lib -DENABLE_FP16=1 -DUSE__FP16=1
LOCAL_LDFLAGS += -Llz4-nougat/lib/obj/local/$(TARGET_ARCH_ABI)/
LOCAL_CXXFLAGS += -std=c++20 -frtti -DENABLE_FP16=1 -DUSE__FP16=1
