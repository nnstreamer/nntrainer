...
class InputTensorsInfo {
public:
  InputTensorsInfo (unsigned int num_of_samples, unsigned int num_of_inputs, unsigned num_of_labels);
  unsigned int count;
...
InputTensorsInfo::InputTensorsInfo(unsigned int _num_of_samples, unsigned int _num_of_inputs, unsigned int _num_of_labels):
  count(0),
