...
lcov -r unittest_total.info "*/Applications/*" "*/nnstreamer/*" "*/meson*/*" "*/build/*" "*/test/*" "*/usr/*" "*/subprojects/*" -o unittest_filtered.info --ignore-errors unused,gcov
# nnstreamer layer is untestable here

# Visualize the report
genhtml -o result unittest_filtered.info -t "nntrainer %{version}-%{release} ${VCS}" --ignore-errors mismatch,source -p ${RPM_BUILD_DIR} --synthesize-missing
